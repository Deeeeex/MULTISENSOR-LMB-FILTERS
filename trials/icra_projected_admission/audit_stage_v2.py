...
ROOT=OUT.parents[1]
for directory in ['icra_gaussian_evidence','icra_marked_control','icra_fusion_holdout','icra_reviewer_revision','icra_admission_revision']:
...
from projected_probability_audit_v2 import audit_probability as audit_new_probability
