...
def main():
    ...
    paths += [OUT / 'PROTOCOL.md', OUT / 'PROJECTION_DIAGNOSTIC.json', OUT.parent / 'icra_admission_revision/SOURCE_REVIEW_CN.md', OUT.parent / 'icra_admission_revision/REJECTION_DIAGNOSTIC.json', previous]
    ...
    config = dict(protocol='icra-projected-admission-v1', stage=args.stage, cohort=args.cohort,
