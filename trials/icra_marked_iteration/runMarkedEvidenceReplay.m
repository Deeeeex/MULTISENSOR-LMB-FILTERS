function runMarkedEvidenceReplay(firstSequence,lastSequence,smoke,arms)
...
resultDir=fullfile(out,'results_development');if ~isfolder(resultDir),mkdir(resultDir);end
...
for seq=firstSequence:lastSequence
    ...
    for condition={'reliable','intermittent'}
        ...
        result=struct('protocol','marked-evidence-ceiling-v1','implementation','mecr-v1', ...
...
for t=1:T
    ...
    for n=1:2
        ...
        else,[local{n},~,W]=updateMarkedLmb(predicted,num2cell(measurements{n,t},1),model,n,t,ratios.likelihoodRatios{n,t});end
    ...
    if strcmp(arm,'local')
        ...
        for n=1:2
            ...
            [posterior{n},stats]=fuseMarkedInputs(inputs,[.5,.5],model,details,cfg,arm,t);
