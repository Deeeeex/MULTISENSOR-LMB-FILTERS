function [updatedObjects, diagnostics, W] = updateMarkedLmbStable( ...
    predictedObjects, measurements, model, sensorIdx, currentTime, ratios)
...
% Independent observation mark multiplies each detection association once.
