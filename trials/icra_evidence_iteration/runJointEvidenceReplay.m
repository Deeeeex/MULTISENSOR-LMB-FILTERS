function runJointEvidenceReplay(firstSequence,lastSequence,smoke,arms)
...
if nargin<4,arms={'qualified_exist','joint_evidence','joint_evidence_recency'};end
...
for seq=firstSequence:lastSequence
    ...
    for condition={'reliable','intermittent'}
        ...
        result=struct('protocol','joint-current-evidence-v1','implementation','je-v1', ...
...
for t=1:T
    ...
    if strcmp(arm,'local')
        ...
        for n=1:2
            ...
            [posterior{n},stats]=fuseJointEvidence(inputs,[.5,.5],model,details,cfg,arm,t);
