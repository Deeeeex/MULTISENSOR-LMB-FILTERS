function [aligned,d,state]=alignPersistentLmbPair(local,remote,threshold,state,mode,t,receiver)
...
[e,state.snapshots]=observationPairEvidence(local,remote,state.snapshots,t);
