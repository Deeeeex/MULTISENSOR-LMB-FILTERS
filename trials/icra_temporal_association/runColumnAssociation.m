function runColumnAssociation(configPath,unitIndex)
...
checkPersistentAssociation();checkColumnAssociation();
...
for condition={'reliable','intermittent'}
    ...
    for a=1:numel(config.arms)
        ...
        result=struct('protocol','icra-restored-association-v1','stage',config.stage, ...
