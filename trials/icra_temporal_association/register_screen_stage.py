...
def main():
    ...
    arms = ['marked_gaussian_evidence_assoc_' + mode for mode in ['quality', 'nis', 'quality_nis']]
    if args.preflight:
        assert sequences == ['0001', '0006', '0007']
        arms[:0] = ['marked_gaussian_evidence', 'marked_gaussian_evidence_assoc_split']
    cfg = dict(protocol='icra-screened-association-v1', stage=args.stage, cohort='development',
