...
def main():
    ...
    arms = ['marked_gaussian_evidence_assoc_direct', 'marked_gaussian_evidence_assoc_temporal']
    if args.preflight:
        assert sequences == ['0000']
        arms.insert(0, 'marked_gaussian_evidence')
    cfg = dict(protocol='icra-temporal-association-v1', stage=args.stage, cohort='development',
