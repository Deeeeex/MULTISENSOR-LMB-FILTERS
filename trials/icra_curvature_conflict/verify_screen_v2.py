...
def main():
    ...
    freeze = OUT/'SCREEN_FREEZE_V2.json'; report_path = OUT/'SCREEN_RESULTS.json'
    ...
    result=dict(passed=True,source_runs=len(cfg['cells']),fusion_distributions=fusion_labels,
        ...
        execution_sha256=sha(OUT/'SCREEN_EXECUTION_V2.json'),csv_sha256=sha(OUT/'ALL_SCREEN_SCORES.csv'),inputs=input_shas)
