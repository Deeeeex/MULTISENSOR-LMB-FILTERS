...
| 诊断子集 | 链路 | 独立源查询数 | 射线穿过更近检测框 | 源距离中位数（m） |
| --- | --- | ---: | ---: | ---: |
| 0006新增虚警源 | reliable | 28 | 0 | 25.808 |
| 0006新增虚警源 | intermittent | 32 | 3 | 24.596 |
| v2x_0002新增虚警源 | reliable | 67 | 0 | 6.439 |
| v2x_0002新增虚警源 | intermittent | 60 | 6 | 6.440 |
| v2xt_0001 真实漏检源 | reliable | 70 | 0 | 38.941 |
| v2xt_0001 真实漏检源 | intermittent | 48 | 0 | 38.964 |
...
| 源距离（m） | 5 | 10 | 20 | 30 | 39 |
| --- | ---: | ---: | ---: | ---: | ---: |
| 全九段拟合的平均检出概率 | 0.957 | 0.938 | 0.873 | 0.760 | 0.612 |
