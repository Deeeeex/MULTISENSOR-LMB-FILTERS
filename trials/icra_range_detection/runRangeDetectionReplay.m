function runRangeDetectionReplay(configPath,unitIndex)
...
qualityPath=fullfile(out,'range_quality');addpath(qualityPath);
...
for condition={'reliable','intermittent'}
    ...
    for a=1:numel(config.arms)
        ...
        result=struct('protocol','icra-range-detection-v1','stage',config.stage, ...
