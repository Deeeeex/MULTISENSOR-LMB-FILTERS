...
def main():
    ...
    logdir=ROOT/'RUN/ICRA_MISS_HISTORY'/args.stage
    ...
    def worker(index,unit):
        ...
        command=['/Applications/MATLAB_R2024a.app/bin/matlab','-singleCompThread','-batch',
                 f"addpath('trials/icra_miss_history');runMissHistoryReplay('{cfgpath.relative_to(ROOT)}',{index+1});"]
    ...
    print('ALL MISS HISTORY STAGE RUNS COMPLETE',args.stage,len(completed),'units',flush=True)
