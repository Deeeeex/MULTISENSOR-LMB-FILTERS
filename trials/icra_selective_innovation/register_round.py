...
def main():
    ...
    result = dict(protocol='selective-current-innovation-v1', timestamp_utc=datetime.now(timezone.utc).isoformat(),
                  ...
                  continuation_rule='All nine development sequences complete; primary sequence-macro OSPA lower than M-No-age and M-ER in both conditions and no higher than M-CR and M-ECR-S in both conditions. Otherwise reject expansion, retain all secondary results.',
    ...
    print('SELECTIVE ROUND FIXED: M-SI primary; four arms; all nine development units first; no independent-holdout claim.', flush=True)
