...
from peer_math import RULES, check_fixtures, source_state, calculate, audit_raw_weights
...
def main():
    ...
    assert cfg['rules'] == RULES and cfg['primary'] == 'peer_joint' and len(cfg['cells']) == 56
