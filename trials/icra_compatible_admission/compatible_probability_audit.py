...
ARMS = ['marked_gaussian_evidence_compatible_'+mode for mode in ['agreement_all','agreement_positive','agreement_conflict','positive_consensus','positive_only']]
...
from compatible_gaussian_audit import check_gaussians
