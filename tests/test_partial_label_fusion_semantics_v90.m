...
secondInside = inside;
secondInside.birthLocation = 2;
[multiLabelAbstentionResult, multiLabelAbstentionDiagnostics] = ...
    fuseLmbPosteriorsByLabel( ...
        {[inside, secondInside], emptyLike(inside)}, ...
        weights, model, weights, labelAbstentionDetails, fovAware);
assert(numel(multiLabelAbstentionResult) == 2);
assert(multiLabelAbstentionDiagnostics. ...
    explicitLabelAbstentionSourceCount == 2);
