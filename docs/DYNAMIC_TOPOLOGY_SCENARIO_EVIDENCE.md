...
11. Generate at most 32 exact-projected joint candidates per M24 state and
    measure paired H=3 returns. Proceed to critic training only if the
    truth-free top-K bank captures at least 80% of states with a privileged
    admissible gain of at least 5%, while its candidate oracle gains at
    least 7% in aggregate with tail, byte and safety gates intact.
