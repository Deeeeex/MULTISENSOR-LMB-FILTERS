...
\begin{figure*}[t]
    ...
    \caption{Confirmatory communication evidence. Left: every paired seed reduces attempted application-layer bytes; the line and band show the 58.28\% mean and 95\% bootstrap interval. Right: each horizontal segment joins the moment and full-GM payloads from one trial, showing a mean absolute saving of 14.63~MB per trial. Exact receiver-output equivalence is reported separately in Sec.~\ref{sec:experiments}.}
