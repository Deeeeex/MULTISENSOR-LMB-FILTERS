...
- Appendix-only AA diagnostic: fixed AA `3.903 / 5.130 / 0.226`, Balanced AA `3.449 / 4.306 / 0.102`, and Cardinality-critical AA `3.457 / 4.328 / 0.095`
...
- `RUN/AA/AA_BALANCED_CARDINALITY_VALIDATION_N10_SEED1_20260604_184128.md`
