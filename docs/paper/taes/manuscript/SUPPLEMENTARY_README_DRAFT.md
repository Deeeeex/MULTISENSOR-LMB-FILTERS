...
| Source manifests | `generated/*_MANIFEST.md` | Records source paths, hashes, scenario roles, and generated evidence provenance. | Keep in source bundle by default; include selected manifests in supplement only if needed. |
