\begin{table*}[t]
\caption{Held-out N50 replication under the same fixed three-arm protocol. Reductions are relative to the fixed spatial-KLA AA baseline; bracketed intervals are 95\% confidence intervals for absolute paired reductions. The run uses base seed 11.}
\label{tab:heldout}
\centering
\tablefont
\begin{tabular}{lcccc}
