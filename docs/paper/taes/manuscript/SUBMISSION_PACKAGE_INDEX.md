...
- Supplementary material decision and, if submitted, a peer-review-ready supplement/readme based on `SUPPLEMENTARY_README_DRAFT.md` and referenced from the manuscript.
...
8. Decide whether to upload optional supplementary material, Code Ocean/DataPort links, or a graphical/video abstract; if a supplement is submitted, ensure it is peer-review-ready and referenced from the main manuscript.
