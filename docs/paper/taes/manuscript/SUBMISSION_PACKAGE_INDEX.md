...
| Optional supplement or response evidence | `generated/heldout_n50_section.tex`, `generated/reproducibility_ledger_table.tex`, `generated/stress_harsh_section.tex`, and `generated/stress_harsh_summary_sentence.tex` | Source-package and response-ready artifacts exist; the harsh-stress N50 table remains response-ready while the concise generated sentence is imported in Discussion. | Decide whether each item belongs in the main paper, supplement, or response file after final page-budget review. |
