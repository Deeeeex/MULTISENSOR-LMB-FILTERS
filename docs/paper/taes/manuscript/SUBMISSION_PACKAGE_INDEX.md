...
| Cover letter | `COVER_LETTER_AND_METADATA_DRAFT.md` | Polished with manuscript type, technical area, bounded TAES-fit statement, simulation-data statement, and AI-assistance disclosure. | Replace bracketed fields, then paste into the portal or upload as requested. |
...
| Final submission audit | `FINAL_SUBMISSION_AUDIT_CN.md` | Maps the user-facing paper-readiness requirements to current evidence, residual metadata actions, and non-claims. | Use as the internal content-readiness sign-off; do not upload by default. |
...
| `FINAL_SUBMISSION_AUDIT_CN.md` | Final requirement-by-evidence audit that records content readiness, residual metadata-only actions, and preserved non-claims. |
...
| `generated/SCENARIO_FAMILY_MANIFEST.md` | Optional topology/FOV/full-topology scenario-family manifest; current topology-ring, partial-FOV, and full-topology entries are fixed-parameter N50 paper-grade scenario-family evidence, with full-topology classified as a zero-disagreement equivalence boundary. |
| `generated/CROSSING_N50_MANIFEST.md` | Optional maneuver/crossing manifest; current base-seed-71 report is fixed-parameter N50 crossing-window boundary evidence with full-vs-reference separation. |
