...
- Major concerns: the method may be perceived as an engineering projection unless the paper keeps the correspondence-contract framing and structural properties visible.
- Technical failings to address before a stronger case: prior-work contrast should remain about missing correspondence, not about claiming that existing AA/KLA methods are generally inadequate.
