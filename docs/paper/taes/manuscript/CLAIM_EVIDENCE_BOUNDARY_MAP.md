...
| Matched posterior barycenters, not label copying alone, drive the main spatial tracking gain. | Results, `tab:paired`, `fig:n50`, Discussion | Main N50 full-vs-reference-only ablation; generated TikZ paired-reduction panel with held-out RMSE inset; held-out N50 replication; harsh-loss, topology-ring, partial-FOV, and full-topology equivalence-boundary generated evidence | Report-driven fragments plus independent verifier for the main N50 local metrics | Do not collapse reference-only and full effects; cardinality effects are shared by both arms, and full-topology is a zero-disagreement ceiling rather than a gain claim. |
...
| Maneuver/crossing evidence, if configured, is an assignment-stability boundary check based on pre-specified crossing-window metrics. | Supplementary/response evidence package; optional reviewer response | `generated/CROSSING_N50_MANIFEST.md`; `generated/crossing_n50_section.tex`; `generated/crossing_n50_evidence.json` | Optional fixed-protocol gate; not active until `crossing_n50_report` is configured and parsed | Do not use N1/N5 smoke or whole-run averages as paper-facing crossing evidence; even N50 crossing evidence does not prove general assignment correctness under all births, deaths, or close maneuvers. |
