...
2. We introduce a factorized quality model that combines posterior covariance, realized link quality, and existence confidence, together with a weak structure-aware decoupled KLA refinement.
