...
The secondary experiments below check how far the retained reliability cues transfer beyond the main GA/KLA operating modes. Unless noted, they reuse the tiered-loss scenario and reporting protocol from Section~\ref{sec:experimental-setup}.
...
Several exploratory modules produced weak, mixed, or negative effects in the current experiments:
