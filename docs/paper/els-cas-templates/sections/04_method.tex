...
\begin{figure}[!t]
  ...
  \caption{Adaptive fusion-weight factorization, showing the shared backbone and the decoupled spatial and existence branches before the FID-FIA existence refinement.}
