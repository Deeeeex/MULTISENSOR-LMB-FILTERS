...
\begin{table}[t]
  ...
  \begin{tabular}{lccc}
    ...
    FI-weighted GA & $62.810 \pm 6.768$ & $0.628$ & $1.254\times$ \\
...
\subsection{Communication sensitivity and robustness}
