...
The new experimental result suggests a sharper interpretation of the Cao-Zhao FID-FIA idea \citep{CaoZhao2025InfoGeometryFusion}. A scalar FID-FIA weight treats Fisher-information accumulation as a whole-posterior utility. In the present code, that scalar baseline is useful for cardinality, but it can trade away spatial RMSE. The branch-decoupled rule gives a more precise use of the same information-geometric signal.
...
\item scalar FID-FIA fusion is a constrained special case that forces the same information-geometric utility into both spatial and existence branches,
