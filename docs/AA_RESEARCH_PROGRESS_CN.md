...
1. 设计下一组非调参的 scenario-family validation: topology variation、partial field-of-view、target maneuver/crossing 或 covariance-consistency diagnostics。
