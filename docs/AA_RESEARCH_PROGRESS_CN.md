...
| 文档维护 | 已建立，持续维护 | 本文件；`docs/AA_LABEL_UNCERTAINTY_AWARE_FUSION_RULE_CN.md` | 当前 checkpoint 已回填 N50 validation、N50 ablation 和 recommendation。 |
...
- 当前 ablation 证明了 barycenter 组件有用，但还没有证明在线/通信受限实现可以达到同样效果。
