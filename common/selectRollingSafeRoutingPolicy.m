...
details.minimumCrossEdges = ...
    jointSelection.minimumCurrentCrossEdges;
details.maximumCrossEdges = ...
    jointSelection.maximumCurrentCrossEdges;
details.successorCrossCount = ...
    nextReserveSelection.crossEdgeCount;
details.minimumSuccessorCrossEdges = ...
    jointSelection.minimumSuccessorCrossEdges;
details.maximumSuccessorCrossEdges = ...
    jointSelection.maximumSuccessorCrossEdges;
details.successorReserveViable = ...
...
injectedScoreDetails = getField( ...
    scoreDetails, 'injectedScoreDetails', struct());
details.posteriorUsed = ...
    (ismember(mode, {'posterior-analytic', 'external-scores'}) && ...
        logical(getField(scoreDetails, 'posteriorUsed', true))) || ...
    logical(getField(injectedScoreDetails, ...
        'posteriorUsed', false));
details.posteriorPayloadMetadataUsed = ...
    payloadConstraintEnforced;
details.truthUsed = logical(getField( ...
    options, 'truthUsed', false)) || ...
    logical(getField(scoreDetails, 'truthUsed', false)) || ...
    logical(getField(injectedScoreDetails, ...
        'truthUsed', false)) || ...
    logical(getField(injectedScoreDetails, ...
