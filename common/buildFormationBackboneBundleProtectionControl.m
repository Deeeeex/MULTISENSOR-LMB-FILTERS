...
singleAdjacency = cell(1, formationCount);
singleFusionWeights = cell(1, formationCount);
singlePolicyDetails = cell(1, formationCount);
...
for formationIdx = 1:formationCount
    ...
    try
        ...
        singleAdjacency{formationIdx} = adjacency;
        singleFusionWeights{formationIdx} = ...
            details.fusionWeightMatrix;
        singlePolicyDetails{formationIdx} = details;
...
control.singleActionAdjacency = singleAdjacency;
control.singleActionFusionWeights = singleFusionWeights;
control.singleActionPolicyDetails = singlePolicyDetails;
