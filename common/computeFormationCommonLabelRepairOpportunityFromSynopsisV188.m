...
if ~isscalar(minimumRiskReductionThreshold) || ...
        ~isnumeric(minimumRiskReductionThreshold) || ...
        ~isfinite(minimumRiskReductionThreshold)
    error('FormationCommonRepairSynopsisV188:InvalidRiskThreshold', ...
        'The minimum common-receiver risk reduction is invalid.');
end
...
metrics.minimumRiskReductionThreshold = ...
