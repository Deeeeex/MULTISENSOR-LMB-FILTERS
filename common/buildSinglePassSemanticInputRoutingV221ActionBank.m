...
transferFractionGrid = reshape(getField(options, ...
    'inputRouteTransferFractionGrid', 1), 1, []);
...
if ~isscalar(sourceWeight) || ~isfinite(sourceWeight) || ...
        ...
        ~validTransferFractionGrid(transferFractionGrid) || ...
...
plan.inputRouteMaximumReferenceLogOddsIncrease = ...
    maximumReferenceLogOddsIncrease;
plan.inputRouteTransferFractionGrid = transferFractionGrid;
...
bank.inputRouteMaximumReferenceLogOddsDrop = ...
    maximumReferenceLogOddsDrop;
bank.inputRouteMaximumReferenceLogOddsIncrease = ...
    maximumReferenceLogOddsIncrease;
bank.inputRouteTransferFractionGrid = transferFractionGrid;
...
function valid = validTransferFractionGrid(values)
valid = isnumeric(values) && isvector(values) && ~isempty(values) && ...
    all(isfinite(values)) && all(values > 0) && all(values <= 1) && ...
