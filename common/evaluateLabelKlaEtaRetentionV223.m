...
details.contractVersion = ...
    'receiver-label-kla-eta-retention-evaluation-v226-v1';
details.referenceExistence = referenceObject.r;
details.candidateExistence = candidateObject.r;
...
elseif ~projection.lowerBoundAllowed && ...
        ~projection.upperBoundAllowed
    details.rejectionReason = ...
        'eta-existence-two-sided-envelope-failed';
elseif ~projection.lowerBoundAllowed
    details.rejectionReason = ...
        'eta-existence-lower-bound-failed';
else
    details.rejectionReason = ...
        'eta-existence-upper-bound-failed';
end
