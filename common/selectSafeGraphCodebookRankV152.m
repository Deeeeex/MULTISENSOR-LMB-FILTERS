...
if numel(presetIdx) ~= 1 || ...
        numel(unique(context.model.dynamicTopologyScenario. ...
            config.sensorGroupIds)) ~= protocol.formationCounts(presetIdx)
    error('V152 graph codebook scale is outside the frozen protocol.');
end
...
details.v152ExpectedSelectedMessageCount = ...
    expectedSelectedMessageCount;
