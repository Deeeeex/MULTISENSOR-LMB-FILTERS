...
if ~isstruct(options) || ~isscalar(options) || ...
        any(~ismember(fieldnames(options), {'referenceMode'}))
    error('RetentionDebt:InvalidOptions', ...
        'The retention-debt reference options are invalid.');
end
referenceMode = getField(options, ...
    'referenceMode', 'fixed-spliced-cycle');
if ~ischar(referenceMode) || ~ismember(referenceMode, ...
        {'fixed-spliced-cycle', 'current-physical-tree'})
    error('RetentionDebt:InvalidOptions', ...
        'The retention-debt reference mode is not registered.');
end
...
[referenceAdjacency, referencePolicyDetails] = ...
    selectSuspensionPolicy( ...
        context, zeros(1, 0), policyOptions, referenceMode);
...
for formationIdx = 1:formationCount
    ...
    try
        [adjacency, details] = ...
            selectSuspensionPolicy( ...
                context, formationId, policyOptions, referenceMode);
        score = scoreRoute( ...
...
while ~isempty(selectedFormationIds)
    ...
    try
        [candidateAdjacency, candidateDetails] = ...
            selectSuspensionPolicy( ...
                context, selectedFormationIds, ...
                policyOptions, referenceMode);
...
control.referenceMode = referenceMode;
...
value = strcmp(identifier, 'TemporalSuspension:Infeasible') || ...
    ...
    strcmp(identifier, 'FormationBundleSuspension:Infeasible') || ...
    strcmp(identifier, 'FormationBundleSuspension:InvalidCandidate');
end

function [adjacency, details] = selectSuspensionPolicy( ...
        context, formationIds, policyOptions, referenceMode)
if strcmp(referenceMode, 'current-physical-tree')
    [adjacency, details] = ...
        selectTemporalFormationBackboneInputBundleSuspensionPolicy( ...
            context, formationIds, struct( ...
                'referenceMode', 'current-physical-tree'));
else
    [adjacency, details] = ...
        selectTemporalCrossEdgeSuspensionPolicy( ...
            context, formationIds, policyOptions);
end
end
