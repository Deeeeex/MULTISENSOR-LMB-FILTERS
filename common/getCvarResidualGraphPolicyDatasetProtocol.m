...
% local measurement update.  Keep that step in the behavior trajectory,
% but never use its default-valued update diagnostics as supervision.
...
protocol.preflightDatasetPath = fullfile( ...
    ...
    'cvar_residual_graph_m24_seed7_t76_v2.mat');
...
protocol.registeredShardPaths = cellfun(@(seed) ...
    fullfile(protocol.defaultOutputDirectory, sprintf( ...
        'cvar_residual_graph_m24_seed%d_t76_t83_v2.mat', seed)), ...
