...
horizonSteps = getField(options, 'horizonSteps', ...
    formationGraphDiameter(logical(context.physicalAdjacency), ...
        groupIds) + protocol.recoveryStepsBeyondFormationDiameter);
...
bank.outcomePolicyName = ...
    'network-budget-reallocated-multi-source-v95-frozen-sequence';
...
bank.formationGraphDiameter = horizonSteps - ...
