...
if ~iscell(fusedPosteriorBySensor) || ...
        ...
        any(~isfinite(participatingSensorIds)) || ...
        any(participatingSensorIds ~= round(participatingSensorIds)) || ...
        any(participatingSensorIds < 1) || ...
        any(participatingSensorIds > sensorCount) || ...
        numel(unique(participatingSensorIds)) ~= ...
            numel(participatingSensorIds)
...
for sensorIdx = 1:sensorCount
    if ~ismember(sensorIdx, participatingSensorIds)
        ...
        fusedBySensor{sensorIdx} = localBySensor{sensorIdx};
        continue;
    end
    localBySensor{sensorIdx} = summarizePosterior( ...
