...
options.inputRouteMaximumReferenceLogOddsIncrease = getField(options, ...
    'inputRouteMaximumReferenceLogOddsIncrease', Inf);
options.inputRouteTransferFractionGrid = getField(options, ...
    'inputRouteTransferFractionGrid', 1);
...
bank.transferFractionGrid = reshape( ...
    options.inputRouteTransferFractionGrid, 1, []);
