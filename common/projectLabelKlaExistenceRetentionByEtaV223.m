...
maximumSubMapReferenceLogOddsDrop = getField(options, ...
    'maximumSubMapReferenceLogOddsDrop', ...
    maximumReferenceLogOddsDrop);
maximumReferenceLogOddsIncrease = getField(options, ...
...
if isempty(inputExistence) || ...
        ...
        maximumReferenceLogOddsDrop < 0 || ...
        ~isscalar(maximumSubMapReferenceLogOddsDrop) || ...
        ~isfinite(maximumSubMapReferenceLogOddsDrop) || ...
        maximumSubMapReferenceLogOddsDrop < 0 || ...
        ~isscalar(maximumReferenceLogOddsIncrease) || ...
        ~isnumeric(maximumReferenceLogOddsIncrease) || ...
        isnan(maximumReferenceLogOddsIncrease) || ...
        maximumReferenceLogOddsIncrease < 0 || ...
...
if referenceExistence >= minimumMapExistence
    ...
    requiredFusedLogOdds = ...
        referenceLogOdds - maximumSubMapReferenceLogOddsDrop;
    protectedMapPositiveReference = false;
end
requiredLogEta = requiredFusedLogOdds - weightedInputLogOdds;
maximumAllowedFusedLogOdds = ...
    referenceLogOdds + maximumReferenceLogOddsIncrease;
lowerBoundAllowed = ...
    candidateLogOdds >= requiredFusedLogOdds - identityTolerance;
upperBoundAllowed = ...
    candidateLogOdds <= maximumAllowedFusedLogOdds + identityTolerance;
allowed = lowerBoundAllowed && upperBoundAllowed;

details = struct();
details.contractVersion = 'label-kla-eta-retention-projection-v226-v1';
...
details.maximumSubMapReferenceLogOddsDrop = ...
    maximumSubMapReferenceLogOddsDrop;
details.maximumReferenceLogOddsIncrease = ...
    maximumReferenceLogOddsIncrease;
details.requiredFusedLogOdds = requiredFusedLogOdds;
details.maximumAllowedFusedLogOdds = maximumAllowedFusedLogOdds;
details.requiredLogEta = requiredLogEta;
details.logEtaMargin = logEta - requiredLogEta;
details.lowerLogOddsMargin = ...
    candidateLogOdds - requiredFusedLogOdds;
details.upperLogOddsMargin = ...
    maximumAllowedFusedLogOdds - candidateLogOdds;
details.lowerBoundAllowed = lowerBoundAllowed;
details.upperBoundAllowed = upperBoundAllowed;
