...
> 此文件保留早期三分区草案的设计记录。用户于 2026-09-08 选定一体化布局，
> 当前 Fig. 1 已改用 `figures/overview.svg` / `.pdf`。
> 最终参考图、prompt、矢量重绘说明见 [一体化主图](main_figure_integrated/README.md)。
> 下文关于三分区和“尚未插入正文”的表述仅描述早期版本。
