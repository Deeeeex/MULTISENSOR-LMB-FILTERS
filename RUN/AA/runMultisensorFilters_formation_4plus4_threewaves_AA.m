% RUNMULTISENSORFILTERS_FORMATION_4PLUS4_THREEWAVES_AA - 4+4 sensor formations + three target streams demo (AA)
close all; clc;
...
gifPathBase = fullfile(outputDir, 'formation_animation_4plus4_threewaves_AA_base.gif');
gifPathAdaptive = fullfile(outputDir, 'formation_animation_4plus4_threewaves_AA_adaptive.gif');
