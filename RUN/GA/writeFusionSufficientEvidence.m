...
% WRITEFUSIONSUFFICIENTEVIDENCE Atomically publish ICASSP evidence files.

validateWriterInputs(summary, config);
...
function validateWriterInputs(summary, config)
requiredConfig = {'evidenceSchema', 'wireSchemaVersion', 'gitCommit', ...
    'numberOfTrials', 'baseSeed', 'firstSeed', 'lastSeed', ...
    'armSelection', 'simulationLength', 'capturePosteriorSnapshots', ...
...
requiredSummary = {'armNames', 'numberOfTrials', 'trialSeeds', ...
    'trials', 'arms', 'scenarioConfig', 'equivalence'};
