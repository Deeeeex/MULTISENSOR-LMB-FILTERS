...
focusWindow = resolveFocusWindow(scenarioConfig, timeCount);
...
fprintf(fid, ['- The static arm is selected by all-time geometry and link ', ...
    'distance; it is not an exhaustive offline performance optimum over ', ...
    'all fixed D12 candidates.\n']);
...
startTime = max(1, round(window(1)));
