...
if generationGitState.researchWorktreeDirty
    error(['Predictive reward evidence generation requires a ', ...
        'clean tracked and untracked-source worktree.']);
end
[~, summary] = runDynamicTopologyOracleGapScreen( ...
    protocol.presetName, protocol.seed, options);
summary.predictiveRewardEvidenceGeneration = ...
    generationGitState;
save('-mat7-binary', summary.matPath, 'summary');
