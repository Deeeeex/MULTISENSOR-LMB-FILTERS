...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=001, alpha=0.70, epsilon=0.05) | 18.8201 | 34.6311 | 0.8836 | 20.7880 | 0.5556 | 5868888 | 5816008 | 36.00 | 40.00 | 120 | 0.2685 | 0.3333 | 0.00 | 140.87 |
| Backbone residual static/current sequence (t=75, mask=101, alpha=0.70, epsilon=0.05) | 18.0414 | 34.6311 | 0.8828 | 20.3472 | 0.5139 | 5867736 | 5764664 | 36.00 | 40.00 | 120 | 0.3671 | 0.0000 | 240.91 | 288.73 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=001, alpha=0.70, epsilon=0.05) | 0.2685 | 0.8333 | 0.0000 | 1.00 | 0.6667 | 1.0000 | 1.67 | 0.0000 |
| Backbone residual static/current sequence (t=75, mask=101, alpha=0.70, epsilon=0.05) | 0.3671 | 0.8333 | 0.1250 | 3.00 | 0.6667 | 1.0000 | 1.92 | 0.0500 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=001, alpha=0.70, epsilon=0.05) | 0.0000 | 1.00 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.3333 | 1.0000 | 0.0000 |
| Backbone residual static/current sequence (t=75, mask=101, alpha=0.70, epsilon=0.05) | 0.1250 | 3.00 | 0.6667 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.6667 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=001, alpha=0.70, epsilon=0.05) | 0.6667 | 3 | 0.6667 | 3 | 0.6667 | 3 | 0.6667 | 3 | NaN | NaN | NaN | 0 | NaN | NaN | NaN | 0.0000 | 1.0000 |
| Backbone residual static/current sequence (t=75, mask=101, alpha=0.70, epsilon=0.05) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 2 | 1.0000 | 1.0000 | 1.0000 | 0.0000 | 0.0000 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=001, alpha=0.70, epsilon=0.05) | 18.8201 | 34.6311 | 5868888 | 0.0000 | 1.00 | 1.0000 | 0.6667 | 0.0000 | 0.3333 | 0.8836 | 20.7880 | 0.5556 |
| Backbone residual static/current sequence (t=75, mask=101, alpha=0.70, epsilon=0.05) | 18.0414 | 34.6311 | 5867736 | 0.1250 | 3.00 | 1.0000 | 0.6667 | 0.0500 | 0.0000 | 0.8828 | 20.3472 | 0.5139 |

## Per-seed tail-node diagnostic

| Seed | Arm | Worst sensor | Sensor E-OSPA | Network mean E-OSPA |
|--:|:--|--:|--:|--:|
| 7 | Backbone residual static/current sequence (t=75, mask=001, alpha=0.70, epsilon=0.05) | 16 | 34.6311 | 18.8201 |
| 7 | Backbone residual static/current sequence (t=75, mask=101, alpha=0.70, epsilon=0.05) | 16 | 34.6311 | 18.0414 |
...
- Available: `1`
- Arm count: `2`
- Arms: `Backbone residual static/current sequence (t=75, mask=001, alpha=0.70, epsilon=0.05), Backbone residual static/current sequence (t=75, mask=101, alpha=0.70, epsilon=0.05)`
- Best diagnostic arm: `Backbone residual static/current sequence (t=75, mask=101, alpha=0.70, epsilon=0.05)`
- Best diagnostic focus E-OSPA: 18.0414
- Best diagnostic attempted bytes: 5867736
