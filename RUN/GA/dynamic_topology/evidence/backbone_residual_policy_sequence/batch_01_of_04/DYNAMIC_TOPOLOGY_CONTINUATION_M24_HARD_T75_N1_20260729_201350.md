...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Local only | 23.4600 | 42.0469 | 1.0402 | 25.1022 | 0.7500 | 0 | 0 | 29.00 | 58.00 | 0 | 0.0000 | 0.0000 | 0.00 | 18.33 |
| Directed fixed index control (w=0.70) | 19.2470 | 34.6420 | 0.8840 | 21.0525 | 0.5833 | 3512112 | 3459232 | 20.00 | 24.00 | 72 | 0.4786 | 0.0000 | 0.00 | 36.06 |
| Backbone-preserving residual static matched control (alpha=0.70, epsilon=0.05) | 18.8201 | 34.6311 | 0.8836 | 20.7880 | 0.5556 | 5868888 | 5816008 | 36.00 | 40.00 | 120 | 0.2685 | 0.0000 | 0.00 | 50.24 |
| Backbone-preserving residual posterior-analytic routing (alpha=0.70, epsilon=0.05) | 18.7966 | 38.6978 | 0.8738 | 21.0225 | 0.5556 | 5860992 | 5808112 | 36.00 | 40.00 | 120 | 0.4268 | 0.0000 | 31.20 | 77.70 |
| Backbone residual static/current sequence (t=75, mask=000, alpha=0.70, epsilon=0.05) | 18.8201 | 34.6311 | 0.8836 | 20.7880 | 0.5556 | 5868888 | 5816008 | 36.00 | 40.00 | 120 | 0.2685 | 0.0000 | 0.00 | 48.28 |
| Backbone residual static/current sequence (t=75, mask=100, alpha=0.70, epsilon=0.05) | 18.2827 | 34.6311 | 0.8839 | 20.2636 | 0.5278 | 5870256 | 5767184 | 36.00 | 40.00 | 120 | 0.3355 | 0.0000 | 106.21 | 142.37 |
...
| Backbone residual static/current sequence (t=75, mask=000, alpha=0.70, epsilon=0.05) | 0.2685 | 0.8333 | 0.0000 | 1.00 | 0.6667 | 1.0000 | 1.67 | 0.0000 |
| Backbone residual static/current sequence (t=75, mask=100, alpha=0.70, epsilon=0.05) | 0.3355 | 0.8333 | 0.0625 | 2.00 | 0.6667 | 1.0000 | 1.79 | 0.0250 |
...
| Backbone residual static/current sequence (t=75, mask=000, alpha=0.70, epsilon=0.05) | 0.0000 | 1.00 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.3333 | 1.0000 | 0.0000 |
| Backbone residual static/current sequence (t=75, mask=100, alpha=0.70, epsilon=0.05) | 0.0625 | 2.00 | 0.3333 | 0.0000 | 1.0000 | 0.0000 | 0.3333 | 0.3333 | 1.0000 | 0.3333 |
...
| Backbone residual static/current sequence (t=75, mask=000, alpha=0.70, epsilon=0.05) | 0.6667 | 3 | 0.6667 | 3 | 0.6667 | 3 | 0.6667 | 3 | NaN | NaN | NaN | 0 | NaN | NaN | NaN | NaN | NaN |
| Backbone residual static/current sequence (t=75, mask=100, alpha=0.70, epsilon=0.05) | 0.6667 | 3 | 0.6667 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 1 | 1.0000 | 1.0000 | 1.0000 | 0.0000 | 0.0000 |
...
| Backbone residual static/current sequence (t=75, mask=000, alpha=0.70, epsilon=0.05) | 18.8201 | 34.6311 | 5868888 | 0.0000 | 1.00 | 1.0000 | 0.6667 | 0.0000 | 0.0000 | 0.8836 | 20.7880 | 0.5556 |
| Backbone residual static/current sequence (t=75, mask=100, alpha=0.70, epsilon=0.05) | 18.2827 | 34.6311 | 5870256 | 0.0625 | 2.00 | 1.0000 | 0.6667 | 0.0250 | 0.0000 | 0.8839 | 20.2636 | 0.5278 |
...
| 7 | Backbone residual static/current sequence (t=75, mask=000, alpha=0.70, epsilon=0.05) | 16 | 34.6311 | 18.8201 |
| 7 | Backbone residual static/current sequence (t=75, mask=100, alpha=0.70, epsilon=0.05) | 16 | 34.6311 | 18.2827 |
...
- Available: `1`
- Arm count: `2`
- Arms: `Backbone residual static/current sequence (t=75, mask=000, alpha=0.70, epsilon=0.05), Backbone residual static/current sequence (t=75, mask=100, alpha=0.70, epsilon=0.05)`
- Best diagnostic arm: `Backbone residual static/current sequence (t=75, mask=100, alpha=0.70, epsilon=0.05)`
- Best diagnostic focus E-OSPA: 18.2827
- Best diagnostic attempted bytes: 5870256
