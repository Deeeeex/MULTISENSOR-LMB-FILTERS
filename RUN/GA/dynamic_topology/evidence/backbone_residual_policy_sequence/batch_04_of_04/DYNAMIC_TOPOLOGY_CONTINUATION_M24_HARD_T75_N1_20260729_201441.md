...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=011, alpha=0.70, epsilon=0.05) | 18.2128 | 34.6311 | 0.8817 | 20.6863 | 0.5278 | 5868600 | 5764856 | 36.00 | 40.00 | 120 | 0.3671 | 0.0000 | 221.58 | 264.86 |
| Backbone residual static/current sequence (t=75, mask=111, alpha=0.70, epsilon=0.05) | 18.0445 | 34.6311 | 0.8831 | 20.3497 | 0.5139 | 5874480 | 5673064 | 36.00 | 40.00 | 120 | 0.4074 | 0.0000 | 314.07 | 352.17 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=011, alpha=0.70, epsilon=0.05) | 0.3671 | 0.8333 | 0.1875 | 3.00 | 0.6667 | 1.0000 | 1.92 | 0.0500 |
| Backbone residual static/current sequence (t=75, mask=111, alpha=0.70, epsilon=0.05) | 0.4074 | 0.8333 | 0.2083 | 3.00 | 0.6667 | 1.0000 | 2.04 | 0.0750 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=011, alpha=0.70, epsilon=0.05) | 0.1875 | 3.00 | 0.6667 | 0.0000 | 1.0000 | 1.0000 | 0.0000 | 0.6667 | 1.0000 | 0.6667 |
| Backbone residual static/current sequence (t=75, mask=111, alpha=0.70, epsilon=0.05) | 0.2083 | 3.00 | 0.6667 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.9167 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=011, alpha=0.70, epsilon=0.05) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 2 | 1.0000 | 1.0000 | 1.0000 | 0.0000 | 0.0000 |
| Backbone residual static/current sequence (t=75, mask=111, alpha=0.70, epsilon=0.05) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 1.0000 | 1.0000 | 0.0000 | 0.0000 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=011, alpha=0.70, epsilon=0.05) | 18.2128 | 34.6311 | 5868600 | 0.1875 | 3.00 | 1.0000 | 0.6667 | 0.0500 | 0.0000 | 0.8817 | 20.6863 | 0.5278 |
| Backbone residual static/current sequence (t=75, mask=111, alpha=0.70, epsilon=0.05) | 18.0445 | 34.6311 | 5874480 | 0.2083 | 3.00 | 1.0000 | 0.6667 | 0.0750 | 0.0000 | 0.8831 | 20.3497 | 0.5139 |

## Per-seed tail-node diagnostic

| Seed | Arm | Worst sensor | Sensor E-OSPA | Network mean E-OSPA |
|--:|:--|--:|--:|--:|
| 7 | Backbone residual static/current sequence (t=75, mask=011, alpha=0.70, epsilon=0.05) | 16 | 34.6311 | 18.2128 |
| 7 | Backbone residual static/current sequence (t=75, mask=111, alpha=0.70, epsilon=0.05) | 16 | 34.6311 | 18.0445 |
...
- Available: `1`
- Arm count: `2`
- Arms: `Backbone residual static/current sequence (t=75, mask=011, alpha=0.70, epsilon=0.05), Backbone residual static/current sequence (t=75, mask=111, alpha=0.70, epsilon=0.05)`
- Best diagnostic arm: `Backbone residual static/current sequence (t=75, mask=111, alpha=0.70, epsilon=0.05)`
