...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=010, alpha=0.70, epsilon=0.05) | 18.4530 | 34.6311 | 0.8824 | 20.6026 | 0.5417 | 5865024 | 5812144 | 36.00 | 40.00 | 120 | 0.3355 | 0.0000 | 97.76 | 141.22 |
| Backbone residual static/current sequence (t=75, mask=110, alpha=0.70, epsilon=0.05) | 18.2847 | 34.6311 | 0.8838 | 20.2658 | 0.5278 | 5870904 | 5720352 | 36.00 | 40.00 | 120 | 0.3774 | 0.0000 | 240.65 | 288.42 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=010, alpha=0.70, epsilon=0.05) | 0.3355 | 0.8333 | 0.1250 | 2.00 | 0.6667 | 1.0000 | 1.79 | 0.0250 |
| Backbone residual static/current sequence (t=75, mask=110, alpha=0.70, epsilon=0.05) | 0.3774 | 0.8333 | 0.1458 | 3.00 | 0.6667 | 1.0000 | 1.92 | 0.0500 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=010, alpha=0.70, epsilon=0.05) | 0.1250 | 2.00 | 0.3333 | 0.0000 | 1.0000 | 0.0000 | 0.0000 | 0.3333 | 1.0000 | 0.3333 |
| Backbone residual static/current sequence (t=75, mask=110, alpha=0.70, epsilon=0.05) | 0.1458 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 0.0000 | 0.3333 | 0.3333 | 1.0000 | 0.5833 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=010, alpha=0.70, epsilon=0.05) | 0.6667 | 3 | 0.6667 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 1 | 1.0000 | 1.0000 | 1.0000 | 0.0000 | 0.0000 |
| Backbone residual static/current sequence (t=75, mask=110, alpha=0.70, epsilon=0.05) | 0.6667 | 3 | 0.6667 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 2 | 1.0000 | 1.0000 | 1.0000 | 0.0000 | 0.0000 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Backbone residual static/current sequence (t=75, mask=010, alpha=0.70, epsilon=0.05) | 18.4530 | 34.6311 | 5865024 | 0.1250 | 2.00 | 1.0000 | 0.6667 | 0.0250 | 0.0000 | 0.8824 | 20.6026 | 0.5417 |
| Backbone residual static/current sequence (t=75, mask=110, alpha=0.70, epsilon=0.05) | 18.2847 | 34.6311 | 5870904 | 0.1458 | 3.00 | 1.0000 | 0.6667 | 0.0500 | 0.0000 | 0.8838 | 20.2658 | 0.5278 |

## Per-seed tail-node diagnostic

| Seed | Arm | Worst sensor | Sensor E-OSPA | Network mean E-OSPA |
|--:|:--|--:|--:|--:|
| 7 | Backbone residual static/current sequence (t=75, mask=010, alpha=0.70, epsilon=0.05) | 16 | 34.6311 | 18.4530 |
| 7 | Backbone residual static/current sequence (t=75, mask=110, alpha=0.70, epsilon=0.05) | 16 | 34.6311 | 18.2847 |
...
- Available: `1`
- Arm count: `2`
- Arms: `Backbone residual static/current sequence (t=75, mask=010, alpha=0.70, epsilon=0.05), Backbone residual static/current sequence (t=75, mask=110, alpha=0.70, epsilon=0.05)`
- Best diagnostic arm: `Backbone residual static/current sequence (t=75, mask=110, alpha=0.70, epsilon=0.05)`
- Best diagnostic focus E-OSPA: 18.2847
- Best diagnostic attempted bytes: 5870904
