...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Rolling-safe posterior-analytic routing (w=0.70) | 25.1206 | 38.6379 | 0.9157 | 26.3899 | 0.8750 | 3406752 | 3357904 | 24.00 | 24.00 | 72 | 0.5289 | 0.0000 | 17.29 | 43.29 |
| Directed rolling-B3 burst control (root=4, ccw, phase=2, w=0.70) | 22.3449 | 34.5380 | 0.9525 | 22.9908 | 0.6944 | 3472848 | 3373136 | 24.00 | 24.00 | 72 | 0.3964 | 0.0000 | 0.20 | 26.63 |
| Privileged rolling-safe current-risk teacher (w=0.70) | 21.0283 | 35.1210 | 0.9871 | 22.5080 | 0.6111 | 3387552 | 3191320 | 24.00 | 24.00 | 72 | 0.5167 | 0.0000 | 60.93 | 87.02 |
| Privileged rolling-safe open-loop teacher (H=2, w=0.70) | 21.0283 | 35.1210 | 0.9871 | 22.5080 | 0.6111 | 3387552 | 3191320 | 24.00 | 24.00 | 72 | 0.5167 | 0.0000 | 97.00 | 123.18 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|
| Rolling-safe posterior-analytic routing (w=0.70) | 0.5289 | 1.0000 | 0.2500 | 3.00 | 0.7083 | 1.0000 | 1.38 | 0.1250 |
| Directed rolling-B3 burst control (root=4, ccw, phase=2, w=0.70) | 0.3964 | 1.0000 | 0.0833 | 3.00 | 0.6806 | 1.0000 | 1.17 | 0.0556 |
| Privileged rolling-safe current-risk teacher (w=0.70) | 0.5167 | 1.0000 | 0.2292 | 3.00 | 0.7083 | 1.0000 | 1.38 | 0.1250 |
| Privileged rolling-safe open-loop teacher (H=2, w=0.70) | 0.5167 | 1.0000 | 0.2292 | 3.00 | 0.7083 | 1.0000 | 1.38 | 0.1250 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Rolling-safe posterior-analytic routing (w=0.70) | 0.2500 | 3.00 | 0.6667 | 0.0000 | 1.0000 | 1.0000 | 0.6667 | 0.3333 | 1.0000 | 1.0000 |
...
| Privileged rolling-safe current-risk teacher (w=0.70) | 0.2292 | 3.00 | 0.6667 | 0.0000 | 1.0000 | 1.0000 | 0.6667 | 0.3333 | 1.0000 | 1.0000 |
| Privileged rolling-safe open-loop teacher (H=2, w=0.70) | 0.2292 | 3.00 | 0.6667 | 0.0000 | 1.0000 | 1.0000 | 0.6667 | 0.3333 | 1.0000 | 1.0000 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Rolling-safe posterior-analytic routing (w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
| Directed rolling-B3 burst control (root=4, ccw, phase=2, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
| Privileged rolling-safe current-risk teacher (w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
| Privileged rolling-safe open-loop teacher (H=2, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Rolling-safe posterior-analytic routing (w=0.70) | 25.1206 | 38.6379 | 3406752 | 0.2500 | 3.00 | 1.0000 | 0.7083 | 0.1250 | 0.0000 | 0.9157 | 26.3899 | 0.8750 |
| Directed rolling-B3 burst control (root=4, ccw, phase=2, w=0.70) | 22.3449 | 34.5380 | 3472848 | 0.0833 | 3.00 | 1.0000 | 0.6806 | 0.0556 | 0.0000 | 0.9525 | 22.9908 | 0.6944 |
| Privileged rolling-safe current-risk teacher (w=0.70) | 21.0283 | 35.1210 | 3387552 | 0.2292 | 3.00 | 1.0000 | 0.7083 | 0.1250 | 0.0000 | 0.9871 | 22.5080 | 0.6111 |
| Privileged rolling-safe open-loop teacher (H=2, w=0.70) | 21.0283 | 35.1210 | 3387552 | 0.2292 | 3.00 | 1.0000 | 0.7083 | 0.1250 | 0.0000 | 0.9871 | 22.5080 | 0.6111 |
...
- Available: `1`
- Arm count: `2`
- Arms: `Privileged rolling-safe current-risk teacher (w=0.70), Privileged rolling-safe open-loop teacher (H=2, w=0.70)`
- Best diagnostic arm: `Privileged rolling-safe current-risk teacher (w=0.70)`
...
- Candidate arm: `Rolling-safe posterior-analytic routing (w=0.70)`
- Candidate mode: `rolling-safe-analytic-w70`
...
- Observed control instances: `1`
- Uniquely observed controls: `1`
- Contract-valid controls: `1`
- Missing controls: `directed-rolling-chunk-q2-dcw-c0-w70 | directed-rolling-chunk-q2-dcw-c1-w70 | directed-rolling-chunk-q2-dccw-c0-w70 | directed-rolling-chunk-q2-dccw-c1-w70 | directed-rolling-chunk-q3-dcw-c0-w70 | directed-rolling-chunk-q3-dccw-c0-w70 | directed-rolling-burst-r1-dcw-p0-w70 | directed-rolling-burst-r1-dcw-p1-w70 | directed-rolling-burst-r1-dcw-p2-w70 | directed-rolling-burst-r1-dccw-p0-w70 | directed-rolling-burst-r1-dccw-p1-w70 | directed-rolling-burst-r1-dccw-p2-w70 | directed-rolling-burst-r2-dcw-p0-w70 | directed-rolling-burst-r2-dcw-p1-w70 | directed-rolling-burst-r2-dcw-p2-w70 | directed-rolling-burst-r2-dccw-p0-w70 | directed-rolling-burst-r2-dccw-p1-w70 | directed-rolling-burst-r2-dccw-p2-w70 | directed-rolling-burst-r3-dcw-p0-w70 | directed-rolling-burst-r3-dcw-p1-w70 | directed-rolling-burst-r3-dcw-p2-w70 | directed-rolling-burst-r3-dccw-p0-w70 | directed-rolling-burst-r3-dccw-p1-w70 | directed-rolling-burst-r3-dccw-p2-w70 | directed-rolling-burst-r4-dcw-p0-w70 | directed-rolling-burst-r4-dcw-p1-w70 | directed-rolling-burst-r4-dcw-p2-w70 | directed-rolling-burst-r4-dccw-p0-w70 | directed-rolling-burst-r4-dccw-p1-w70 | directed-link-aware-rolling-b3-w70`
- Duplicate controls: ``
- Invalid controls: ``
- Complete matched control set: `0`
- Scheduled behavior contract passed: `1`
...
- `directed-rolling-burst-r4-dccw-p2-w70 | expected=1000-0000-0842 | observed=1000-0000-0842 | selected=1000-0000-0842`
