...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Directed rolling-B3 burst control (root=4, ccw, phase=2, w=0.70) | 22.3449 | 34.5380 | 0.9525 | 22.9908 | 0.6944 | 3472848 | 3373136 | 24.00 | 24.00 | 72 | 0.3964 | 0.0000 | 0.21 | 25.99 |
| Privileged rolling-safe current-risk teacher (w=0.70) | 21.0283 | 35.1210 | 0.9871 | 22.5080 | 0.6111 | 3387552 | 3191320 | 24.00 | 24.00 | 72 | 0.5167 | 0.0000 | 59.84 | 85.36 |
| Privileged rolling-safe minimax-risk teacher (w=0.70) | 21.2706 | 35.1210 | 0.9783 | 22.2051 | 0.6250 | 3372720 | 3176488 | 24.00 | 24.00 | 72 | 0.5042 | 0.0000 | 59.51 | 84.96 |
...
| Privileged rolling-safe minimax-risk teacher (w=0.70) | 0.5042 | 1.0000 | 0.2083 | 3.00 | 0.6944 | 1.0000 | 1.38 | 0.1250 |
...
| Privileged rolling-safe minimax-risk teacher (w=0.70) | 0.2083 | 3.00 | 1.0000 | 0.0000 | 1.0000 | 1.0000 | 0.6667 | 0.3333 | 1.0000 | 1.0000 |
...
| Privileged rolling-safe minimax-risk teacher (w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
...
| Privileged rolling-safe minimax-risk teacher (w=0.70) | 21.2706 | 35.1210 | 3372720 | 0.2083 | 3.00 | 1.0000 | 0.6944 | 0.1250 | 0.0000 | 0.9783 | 22.2051 | 0.6250 |
...
- Available: `1`
- Arm count: `2`
- Arms: `Privileged rolling-safe current-risk teacher (w=0.70), Privileged rolling-safe minimax-risk teacher (w=0.70)`
