...
- Best mean gain: `+6.024%`
- Best tail-safe mean gain: `+6.024%`
...
| `v156-sparse-reference-label-k1` | 1+2+4+5+3+6 | 2 | NaN | +0.435100 | 1 | +6.024% | +15.440% | +0.260% | +9.682% | +17.635% | +6.003% | 1 |
