...
- Best mean gain: `+5.478%`
- Best tail-safe mean gain: `+5.478%`
...
| `v156-sparse-reference-label-k4` | 1+2+4+5+3+6 | 2 | NaN | +0.435100 | 1 | +5.478% | +13.330% | +0.126% | +8.240% | +11.983% | +6.472% | 1 |
