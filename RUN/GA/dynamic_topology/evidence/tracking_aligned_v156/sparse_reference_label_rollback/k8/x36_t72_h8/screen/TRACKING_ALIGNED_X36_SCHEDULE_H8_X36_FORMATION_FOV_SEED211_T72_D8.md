...
- Best mean gain: `+5.871%`
- Best tail-safe mean gain: `+5.871%`
...
| `v156-sparse-reference-label-k8` | 1+2+4+5+3+6 | 2 | NaN | +0.435100 | 1 | +5.871% | +15.343% | +0.125% | +9.682% | +15.991% | +5.995% | 1 |
