...
- Best mean gain: `+2.671%`
- Best tail-safe mean gain: `+2.671%`
...
| `v99-online-positive-net-f1-f2-f4-f5` | 1+2+4+5 | 3 | NaN | +0.139103 | 1 | +2.671% | -1.406% | +7.669% | +0.000% | +3.973% | +5.908% | 1 |
