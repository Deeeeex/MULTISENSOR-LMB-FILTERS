...
- Best mean gain: `+2.799%`
- Best tail-safe mean gain: `+2.799%`
...
| `v99-online-positive-net-f1-f2-f4-f5` | 1+2+4+5 | 3 | NaN | +0.139103 | 1 | +2.799% | -0.719% | +7.669% | +0.000% | +6.134% | +5.997% | 1 |
