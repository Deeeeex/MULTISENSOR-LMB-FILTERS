...
- Best mean gain: `+1.655%`
- Best tail-safe mean gain: `+1.655%`
...
| `v99-online-positive-net-f1-f2-f4-f5` | 1+2+4+5 | 3 | NaN | +0.139103 | 1 | +1.655% | +0.673% | +0.000% | +0.000% | +2.819% | +5.211% | 1 |
