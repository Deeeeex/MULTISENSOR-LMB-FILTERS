...
- Generation commit: `14a9e1f202f430d5a53bdb55267cd3aef4cfed3e`
...
- Best mean gain: `+2.639%`
- Best tail-safe mean gain: `+2.639%`
...
| `v99-online-positive-net-f1-f2-f4-f5` | 1+2+4+5 | 3 | NaN | +0.139103 | 1 | +2.639% | +0.092% | +7.669% | +0.000% | +4.991% | +5.697% | 1 |
