...
- Best mean gain: `+2.673%`
- Best tail-safe mean gain: `+2.673%`
...
| `v99-online-positive-net-f1-f2-f4-f5` | 1+2+4+5 | 3 | NaN | +0.139103 | 1 | +2.673% | +0.382% | +7.669% | +0.000% | +5.712% | +5.530% | 1 |
