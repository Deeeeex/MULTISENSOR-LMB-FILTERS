...
- Best mean gain: `+9.044%`
- Best tail-safe mean gain: `+9.044%`
...
| `v99-online-positive-net-f1-f3-f4` | 1+3+4 | 3 | NaN | +0.429701 | 1 | +9.044% | +3.734% | +28.584% | +0.000% | +21.104% | +5.080% | 1 |
