...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=60-24-24, w=0.70) | 24.4974 | 38.6686 | 0.9177 | 25.4415 | 0.8472 | 3499800 | 3499800 | 24.00 | 24.00 | 72 | 0.3818 | 0.0000 | 7.81 | 42.83 |
| Truth-free rolling-safe action sequence (t=75, codes=64-24-24, w=0.70) | 23.3417 | 47.6170 | 0.9253 | 26.1185 | 0.7917 | 3491760 | 3440224 | 24.00 | 24.00 | 72 | 0.4248 | 0.0000 | 8.67 | 45.68 |
| Truth-free rolling-safe action sequence (t=75, codes=68-24-24, w=0.70) | 24.5823 | 40.3537 | 0.9113 | 26.7540 | 0.8750 | 3470280 | 3367880 | 24.00 | 24.00 | 72 | 0.4386 | 0.0000 | 9.49 | 51.39 |
| Truth-free rolling-safe action sequence (t=75, codes=72-24-24, w=0.70) | 24.2297 | 44.4508 | 0.9149 | 25.7413 | 0.8333 | 3480648 | 3429112 | 24.00 | 24.00 | 72 | 0.3964 | 0.0000 | 9.50 | 50.22 |
| Truth-free rolling-safe action sequence (t=75, codes=76-24-24, w=0.70) | 23.8548 | 38.6686 | 0.9252 | 24.0240 | 0.7778 | 3492384 | 3440848 | 23.67 | 24.00 | 72 | 0.3964 | 0.0000 | 9.28 | 50.77 |
| Truth-free rolling-safe action sequence (t=75, codes=24-24-24, w=0.70) | 22.3449 | 34.5380 | 0.9525 | 22.9908 | 0.6944 | 3472848 | 3373136 | 24.00 | 24.00 | 72 | 0.3964 | 0.0000 | 0.27 | 35.48 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=60-24-24, w=0.70) | 0.3818 | 1.0000 | 0.0833 | 3.00 | 0.6944 | 1.0000 | 1.17 | 0.0556 |
| Truth-free rolling-safe action sequence (t=75, codes=64-24-24, w=0.70) | 0.4248 | 1.0000 | 0.1042 | 3.00 | 0.6806 | 1.0000 | 1.21 | 0.0694 |
| Truth-free rolling-safe action sequence (t=75, codes=68-24-24, w=0.70) | 0.4386 | 1.0000 | 0.1250 | 3.00 | 0.7083 | 1.0000 | 1.25 | 0.0833 |
| Truth-free rolling-safe action sequence (t=75, codes=72-24-24, w=0.70) | 0.3964 | 1.0000 | 0.0833 | 3.00 | 0.6944 | 1.0000 | 1.17 | 0.0556 |
| Truth-free rolling-safe action sequence (t=75, codes=76-24-24, w=0.70) | 0.3964 | 1.0000 | 0.1042 | 3.00 | 0.6806 | 1.0000 | 1.21 | 0.0694 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=60-24-24, w=0.70) | 0.0833 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.5000 |
| Truth-free rolling-safe action sequence (t=75, codes=64-24-24, w=0.70) | 0.1042 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.6667 |
| Truth-free rolling-safe action sequence (t=75, codes=68-24-24, w=0.70) | 0.1250 | 3.00 | 0.6667 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.6667 |
| Truth-free rolling-safe action sequence (t=75, codes=72-24-24, w=0.70) | 0.0833 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.5000 |
| Truth-free rolling-safe action sequence (t=75, codes=76-24-24, w=0.70) | 0.1042 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.5000 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=60-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
| Truth-free rolling-safe action sequence (t=75, codes=64-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
| Truth-free rolling-safe action sequence (t=75, codes=68-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
| Truth-free rolling-safe action sequence (t=75, codes=72-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
| Truth-free rolling-safe action sequence (t=75, codes=76-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=60-24-24, w=0.70) | 24.4974 | 38.6686 | 3499800 | 0.0833 | 3.00 | 1.0000 | 0.6944 | 0.0556 | 0.0000 | 0.9177 | 25.4415 | 0.8472 |
| Truth-free rolling-safe action sequence (t=75, codes=64-24-24, w=0.70) | 23.3417 | 47.6170 | 3491760 | 0.1042 | 3.00 | 1.0000 | 0.6806 | 0.0694 | 0.0000 | 0.9253 | 26.1185 | 0.7917 |
| Truth-free rolling-safe action sequence (t=75, codes=68-24-24, w=0.70) | 24.5823 | 40.3537 | 3470280 | 0.1250 | 3.00 | 1.0000 | 0.7083 | 0.0833 | 0.0000 | 0.9113 | 26.7540 | 0.8750 |
| Truth-free rolling-safe action sequence (t=75, codes=72-24-24, w=0.70) | 24.2297 | 44.4508 | 3480648 | 0.0833 | 3.00 | 1.0000 | 0.6944 | 0.0556 | 0.0000 | 0.9149 | 25.7413 | 0.8333 |
| Truth-free rolling-safe action sequence (t=75, codes=76-24-24, w=0.70) | 23.8548 | 38.6686 | 3492384 | 0.1042 | 3.00 | 1.0000 | 0.6806 | 0.0694 | 0.0000 | 0.9252 | 24.0240 | 0.7778 |
...
|--:|:--|--:|--:|--:|
| 7 | Truth-free rolling-safe action sequence (t=75, codes=60-24-24, w=0.70) | 16 | 38.6686 | 24.4974 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=64-24-24, w=0.70) | 17 | 47.6170 | 23.3417 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=68-24-24, w=0.70) | 24 | 40.3537 | 24.5823 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=72-24-24, w=0.70) | 14 | 44.4508 | 24.2297 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=76-24-24, w=0.70) | 16 | 38.6686 | 23.8548 |
