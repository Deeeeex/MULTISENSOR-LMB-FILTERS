...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Directed rolling-B3 burst control (root=4, ccw, phase=2, w=0.70) | 21.7219 | 43.0102 | 1.0814 | 27.9737 | 0.8194 | 3482928 | 3383888 | 24.00 | 24.00 | 72 | 0.3818 | 0.0000 | 0.23 | 27.90 |
| Privileged rolling-safe minimax-risk teacher (w=0.70) | 18.6463 | 48.7124 | 1.0600 | 25.0879 | 0.6389 | 3509424 | 3410384 | 24.00 | 24.00 | 72 | 0.5042 | 0.0000 | 64.81 | 93.50 |
...
| Privileged rolling-safe minimax-risk teacher (w=0.70) | 0.2083 | 3.00 | 0.6667 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.9167 |
...
| Privileged rolling-safe minimax-risk teacher (w=0.70) | 18.6463 | 48.7124 | 3509424 | 0.2083 | 3.00 | 1.0000 | 0.6944 | 0.1250 | 0.0000 | 1.0600 | 25.0879 | 0.6389 |
...
| 19 | Privileged rolling-safe minimax-risk teacher (w=0.70) | 15 | 48.7124 | 18.6463 |
...
- Available: `1`
- Arm count: `1`
- Arms: `Privileged rolling-safe minimax-risk teacher (w=0.70)`
- Best diagnostic arm: `Privileged rolling-safe minimax-risk teacher (w=0.70)`
- Best diagnostic focus E-OSPA: 18.6463
- Best diagnostic attempted bytes: 3509424
