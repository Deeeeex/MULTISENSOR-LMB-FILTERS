...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=62-24-24, w=0.70) | 23.8239 | 38.6686 | 0.9410 | 22.9280 | 0.7639 | 3445368 | 3292104 | 23.67 | 24.00 | 72 | 0.4107 | 0.0000 | 7.81 | 42.30 |
| Truth-free rolling-safe action sequence (t=75, codes=66-24-24, w=0.70) | 23.7106 | 37.8442 | 0.9335 | 24.9622 | 0.7917 | 3462912 | 3412048 | 24.00 | 24.00 | 72 | 0.3964 | 0.0000 | 8.62 | 45.82 |
| Truth-free rolling-safe action sequence (t=75, codes=70-24-24, w=0.70) | 23.5809 | 39.3178 | 0.9341 | 25.3591 | 0.7778 | 3492216 | 3440680 | 24.00 | 24.00 | 72 | 0.4248 | 0.0000 | 9.50 | 50.82 |
| Truth-free rolling-safe action sequence (t=75, codes=74-24-24, w=0.70) | 23.3243 | 41.8686 | 0.9054 | 25.3062 | 0.7639 | 3474144 | 3422608 | 24.00 | 24.00 | 72 | 0.4522 | 0.0000 | 9.44 | 50.21 |
| Truth-free rolling-safe action sequence (t=75, codes=78-24-24, w=0.70) | 23.1663 | 41.9307 | 0.9385 | 24.2932 | 0.7500 | 3516480 | 3464944 | 24.00 | 24.00 | 72 | 0.3964 | 0.0000 | 9.42 | 50.54 |
| Truth-free rolling-safe action sequence (t=75, codes=24-24-24, w=0.70) | 22.3449 | 34.5380 | 0.9525 | 22.9908 | 0.6944 | 3472848 | 3373136 | 24.00 | 24.00 | 72 | 0.3964 | 0.0000 | 0.27 | 35.50 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=62-24-24, w=0.70) | 0.4107 | 1.0000 | 0.1250 | 3.00 | 0.6944 | 1.0000 | 1.25 | 0.0833 |
| Truth-free rolling-safe action sequence (t=75, codes=66-24-24, w=0.70) | 0.3964 | 1.0000 | 0.0833 | 3.00 | 0.7083 | 1.0000 | 1.17 | 0.0556 |
| Truth-free rolling-safe action sequence (t=75, codes=70-24-24, w=0.70) | 0.4248 | 1.0000 | 0.1042 | 3.00 | 0.6806 | 1.0000 | 1.21 | 0.0694 |
| Truth-free rolling-safe action sequence (t=75, codes=74-24-24, w=0.70) | 0.4522 | 1.0000 | 0.1250 | 3.00 | 0.6667 | 1.0000 | 1.25 | 0.0833 |
| Truth-free rolling-safe action sequence (t=75, codes=78-24-24, w=0.70) | 0.3964 | 1.0000 | 0.1042 | 3.00 | 0.6667 | 1.0000 | 1.17 | 0.0556 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=62-24-24, w=0.70) | 0.1250 | 3.00 | 0.0000 | 0.0000 | 1.0000 | 1.0000 | 0.0000 | 0.3333 | 1.0000 | 0.5833 |
| Truth-free rolling-safe action sequence (t=75, codes=66-24-24, w=0.70) | 0.0833 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.5000 |
| Truth-free rolling-safe action sequence (t=75, codes=70-24-24, w=0.70) | 0.1042 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.5833 |
| Truth-free rolling-safe action sequence (t=75, codes=74-24-24, w=0.70) | 0.1250 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.6667 |
| Truth-free rolling-safe action sequence (t=75, codes=78-24-24, w=0.70) | 0.1042 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.6667 | 1.0000 | 0.5000 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=62-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
| Truth-free rolling-safe action sequence (t=75, codes=66-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
| Truth-free rolling-safe action sequence (t=75, codes=70-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
| Truth-free rolling-safe action sequence (t=75, codes=74-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
| Truth-free rolling-safe action sequence (t=75, codes=78-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=62-24-24, w=0.70) | 23.8239 | 38.6686 | 3445368 | 0.1250 | 3.00 | 1.0000 | 0.6944 | 0.0833 | 0.0000 | 0.9410 | 22.9280 | 0.7639 |
| Truth-free rolling-safe action sequence (t=75, codes=66-24-24, w=0.70) | 23.7106 | 37.8442 | 3462912 | 0.0833 | 3.00 | 1.0000 | 0.7083 | 0.0556 | 0.0000 | 0.9335 | 24.9622 | 0.7917 |
| Truth-free rolling-safe action sequence (t=75, codes=70-24-24, w=0.70) | 23.5809 | 39.3178 | 3492216 | 0.1042 | 3.00 | 1.0000 | 0.6806 | 0.0694 | 0.0000 | 0.9341 | 25.3591 | 0.7778 |
| Truth-free rolling-safe action sequence (t=75, codes=74-24-24, w=0.70) | 23.3243 | 41.8686 | 3474144 | 0.1250 | 3.00 | 1.0000 | 0.6667 | 0.0833 | 0.0000 | 0.9054 | 25.3062 | 0.7639 |
| Truth-free rolling-safe action sequence (t=75, codes=78-24-24, w=0.70) | 23.1663 | 41.9307 | 3516480 | 0.1042 | 3.00 | 1.0000 | 0.6667 | 0.0556 | 0.0000 | 0.9385 | 24.2932 | 0.7500 |
...
|--:|:--|--:|--:|--:|
| 7 | Truth-free rolling-safe action sequence (t=75, codes=62-24-24, w=0.70) | 16 | 38.6686 | 23.8239 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=66-24-24, w=0.70) | 20 | 37.8442 | 23.7106 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=70-24-24, w=0.70) | 16 | 39.3178 | 23.5809 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=74-24-24, w=0.70) | 8 | 41.8686 | 23.3243 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=78-24-24, w=0.70) | 20 | 41.9307 | 23.1663 |
