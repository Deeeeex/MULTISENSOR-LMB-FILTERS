...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=63-24-24, w=0.70) | 24.5176 | 47.6170 | 0.9313 | 26.4342 | 0.8611 | 3493680 | 3442144 | 24.00 | 24.00 | 72 | 0.3964 | 0.0000 | 7.71 | 42.29 |
| Truth-free rolling-safe action sequence (t=75, codes=67-24-24, w=0.70) | 23.2863 | 38.7907 | 0.9249 | 24.3523 | 0.7639 | 3463416 | 3361016 | 24.00 | 24.00 | 72 | 0.4107 | 0.0000 | 8.50 | 45.33 |
| Truth-free rolling-safe action sequence (t=75, codes=71-24-24, w=0.70) | 24.0683 | 42.0963 | 0.9341 | 26.1792 | 0.8194 | 3483432 | 3431896 | 24.00 | 24.00 | 72 | 0.4522 | 0.0000 | 9.43 | 50.12 |
| Truth-free rolling-safe action sequence (t=75, codes=75-24-24, w=0.70) | 24.4974 | 38.6686 | 0.9177 | 25.4415 | 0.8472 | 3499800 | 3499800 | 24.00 | 24.00 | 72 | 0.3818 | 0.0000 | 9.39 | 50.17 |
| Truth-free rolling-safe action sequence (t=75, codes=24-24-24, w=0.70) | 22.3449 | 34.5380 | 0.9525 | 22.9908 | 0.6944 | 3472848 | 3373136 | 24.00 | 24.00 | 72 | 0.3964 | 0.0000 | 0.30 | 40.96 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=63-24-24, w=0.70) | 0.3964 | 1.0000 | 0.0833 | 3.00 | 0.6944 | 1.0000 | 1.17 | 0.0556 |
| Truth-free rolling-safe action sequence (t=75, codes=67-24-24, w=0.70) | 0.4107 | 1.0000 | 0.1042 | 3.00 | 0.6944 | 1.0000 | 1.21 | 0.0694 |
| Truth-free rolling-safe action sequence (t=75, codes=71-24-24, w=0.70) | 0.4522 | 1.0000 | 0.1250 | 3.00 | 0.6806 | 1.0000 | 1.25 | 0.0833 |
| Truth-free rolling-safe action sequence (t=75, codes=75-24-24, w=0.70) | 0.3818 | 1.0000 | 0.0833 | 3.00 | 0.6944 | 1.0000 | 1.17 | 0.0556 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=63-24-24, w=0.70) | 0.0833 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.5000 |
| Truth-free rolling-safe action sequence (t=75, codes=67-24-24, w=0.70) | 0.1042 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.5833 |
| Truth-free rolling-safe action sequence (t=75, codes=71-24-24, w=0.70) | 0.1250 | 3.00 | 0.6667 | 0.0000 | 1.0000 | 1.0000 | 0.6667 | 0.3333 | 1.0000 | 0.6667 |
| Truth-free rolling-safe action sequence (t=75, codes=75-24-24, w=0.70) | 0.0833 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.5000 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=63-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
| Truth-free rolling-safe action sequence (t=75, codes=67-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
| Truth-free rolling-safe action sequence (t=75, codes=71-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
| Truth-free rolling-safe action sequence (t=75, codes=75-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=63-24-24, w=0.70) | 24.5176 | 47.6170 | 3493680 | 0.0833 | 3.00 | 1.0000 | 0.6944 | 0.0556 | 0.0000 | 0.9313 | 26.4342 | 0.8611 |
| Truth-free rolling-safe action sequence (t=75, codes=67-24-24, w=0.70) | 23.2863 | 38.7907 | 3463416 | 0.1042 | 3.00 | 1.0000 | 0.6944 | 0.0694 | 0.0000 | 0.9249 | 24.3523 | 0.7639 |
| Truth-free rolling-safe action sequence (t=75, codes=71-24-24, w=0.70) | 24.0683 | 42.0963 | 3483432 | 0.1250 | 3.00 | 1.0000 | 0.6806 | 0.0833 | 0.0000 | 0.9341 | 26.1792 | 0.8194 |
| Truth-free rolling-safe action sequence (t=75, codes=75-24-24, w=0.70) | 24.4974 | 38.6686 | 3499800 | 0.0833 | 3.00 | 1.0000 | 0.6944 | 0.0556 | 0.0000 | 0.9177 | 25.4415 | 0.8472 |
...
|--:|:--|--:|--:|--:|
| 7 | Truth-free rolling-safe action sequence (t=75, codes=63-24-24, w=0.70) | 17 | 47.6170 | 24.5176 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=67-24-24, w=0.70) | 18 | 38.7907 | 23.2863 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=71-24-24, w=0.70) | 10 | 42.0963 | 24.0683 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=75-24-24, w=0.70) | 16 | 38.6686 | 24.4974 |
