...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Directed rolling-B3 burst control (root=4, ccw, phase=2, w=0.70) | 22.3449 | 34.5380 | 0.9525 | 22.9908 | 0.6944 | 3472848 | 3373136 | 24.00 | 24.00 | 72 | 0.3964 | 0.0000 | 0.29 | 36.27 |
| Learned rolling-safe rollout edge routing (w=0.70) | 21.7036 | 38.8181 | 0.9140 | 24.5890 | 0.6806 | 3520296 | 3520296 | 24.00 | 24.00 | 72 | 0.4915 | 0.0000 | 24.31 | 60.24 |
...
| Learned rolling-safe rollout edge routing (w=0.70) | 0.4915 | 1.0000 | 0.1875 | 3.00 | 0.6944 | 1.0000 | 1.38 | 0.1250 |
...
| Learned rolling-safe rollout edge routing (w=0.70) | 0.1875 | 3.00 | 0.0000 | 0.0000 | 1.0000 | 1.0000 | 0.0000 | 0.6667 | 1.0000 | 0.7500 |
...
| Learned rolling-safe rollout edge routing (w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
...
| Learned rolling-safe rollout edge routing (w=0.70) | 21.7036 | 38.8181 | 3520296 | 0.1875 | 3.00 | 1.0000 | 0.6944 | 0.1250 | 0.0000 | 0.9140 | 24.5890 | 0.6806 |

## Per-seed tail-node diagnostic

| Seed | Arm | Worst sensor | Sensor E-OSPA | Network mean E-OSPA |
|--:|:--|--:|--:|--:|
| 7 | Directed rolling-B3 burst control (root=4, ccw, phase=2, w=0.70) | 22 | 34.5380 | 22.3449 |
| 7 | Learned rolling-safe rollout edge routing (w=0.70) | 22 | 38.8181 | 21.7036 |
...
- Candidate arm: `Learned rolling-safe rollout edge routing (w=0.70)`
- Candidate mode: `learned-rolling-safe-rollout-w70`
