...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Offline centralized counterfactual-teacher sequence (t=75, codes=41-24-24, w=0.70) | 24.5328 | 34.5380 | 0.9158 | 24.4492 | 0.8194 | 3442512 | 3391648 | 24.00 | 24.00 | 72 | 0.4248 | 0.0000 | 63.38 | 90.51 |
| Offline centralized counterfactual-teacher sequence (t=75, codes=43-24-24, w=0.70) | 24.2297 | 44.4508 | 0.9149 | 25.7413 | 0.8333 | 3480648 | 3429112 | 24.00 | 24.00 | 72 | 0.3964 | 0.0000 | 75.81 | 105.20 |
| Offline centralized counterfactual-teacher sequence (t=75, codes=45-24-24, w=0.70) | 27.9337 | 44.4508 | 0.8526 | 27.3976 | 1.0417 | 3451464 | 3399928 | 24.00 | 24.00 | 72 | 0.4522 | 0.0000 | 73.57 | 100.48 |
| Truth-free rolling-safe action sequence (t=75, codes=24-24-24, w=0.70) | 22.3449 | 34.5380 | 0.9525 | 22.9908 | 0.6944 | 3472848 | 3373136 | 24.00 | 24.00 | 72 | 0.3964 | 0.0000 | 0.23 | 27.34 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|
| Offline centralized counterfactual-teacher sequence (t=75, codes=41-24-24, w=0.70) | 0.4248 | 1.0000 | 0.1042 | 3.00 | 0.6944 | 1.0000 | 1.21 | 0.0694 |
| Offline centralized counterfactual-teacher sequence (t=75, codes=43-24-24, w=0.70) | 0.3964 | 1.0000 | 0.0833 | 3.00 | 0.6944 | 1.0000 | 1.17 | 0.0556 |
| Offline centralized counterfactual-teacher sequence (t=75, codes=45-24-24, w=0.70) | 0.4522 | 1.0000 | 0.1250 | 3.00 | 0.7083 | 1.0000 | 1.25 | 0.0833 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Offline centralized counterfactual-teacher sequence (t=75, codes=41-24-24, w=0.70) | 0.1042 | 3.00 | 0.0000 | 0.0000 | 1.0000 | 1.0000 | 0.0000 | 0.3333 | 1.0000 | 0.4167 |
| Offline centralized counterfactual-teacher sequence (t=75, codes=43-24-24, w=0.70) | 0.0833 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.5000 |
| Offline centralized counterfactual-teacher sequence (t=75, codes=45-24-24, w=0.70) | 0.1250 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.5833 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Offline centralized counterfactual-teacher sequence (t=75, codes=41-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
| Offline centralized counterfactual-teacher sequence (t=75, codes=43-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
| Offline centralized counterfactual-teacher sequence (t=75, codes=45-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Offline centralized counterfactual-teacher sequence (t=75, codes=41-24-24, w=0.70) | 24.5328 | 34.5380 | 3442512 | 0.1042 | 3.00 | 1.0000 | 0.6944 | 0.0694 | 0.0000 | 0.9158 | 24.4492 | 0.8194 |
| Offline centralized counterfactual-teacher sequence (t=75, codes=43-24-24, w=0.70) | 24.2297 | 44.4508 | 3480648 | 0.0833 | 3.00 | 1.0000 | 0.6944 | 0.0556 | 0.0000 | 0.9149 | 25.7413 | 0.8333 |
| Offline centralized counterfactual-teacher sequence (t=75, codes=45-24-24, w=0.70) | 27.9337 | 44.4508 | 3451464 | 0.1250 | 3.00 | 1.0000 | 0.7083 | 0.0833 | 0.0000 | 0.8526 | 27.3976 | 1.0417 |
...
|--:|:--|--:|--:|--:|
| 7 | Offline centralized counterfactual-teacher sequence (t=75, codes=41-24-24, w=0.70) | 22 | 34.5380 | 24.5328 |
| 7 | Offline centralized counterfactual-teacher sequence (t=75, codes=43-24-24, w=0.70) | 14 | 44.4508 | 24.2297 |
| 7 | Offline centralized counterfactual-teacher sequence (t=75, codes=45-24-24, w=0.70) | 14 | 44.4508 | 27.9337 |
...
- Available: `1`
- Arm count: `3`
- Arms: `Offline centralized counterfactual-teacher sequence (t=75, codes=41-24-24, w=0.70), Offline centralized counterfactual-teacher sequence (t=75, codes=43-24-24, w=0.70), Offline centralized counterfactual-teacher sequence (t=75, codes=45-24-24, w=0.70)`
- Best diagnostic arm: `Offline centralized counterfactual-teacher sequence (t=75, codes=43-24-24, w=0.70)`
- Best diagnostic focus E-OSPA: 24.2297
- Best diagnostic attempted bytes: 3480648
