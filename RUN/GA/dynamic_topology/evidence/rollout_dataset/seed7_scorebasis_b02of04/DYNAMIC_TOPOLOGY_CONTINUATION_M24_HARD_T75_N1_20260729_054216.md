...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=61-24-24, w=0.70) | 23.8548 | 38.6686 | 0.9252 | 24.0240 | 0.7778 | 3492384 | 3440848 | 23.67 | 24.00 | 72 | 0.3964 | 0.0000 | 7.70 | 42.41 |
| Truth-free rolling-safe action sequence (t=75, codes=65-24-24, w=0.70) | 23.3447 | 47.6170 | 0.9219 | 26.1225 | 0.7917 | 3448584 | 3348200 | 24.00 | 24.00 | 72 | 0.4522 | 0.0000 | 8.55 | 45.41 |
| Truth-free rolling-safe action sequence (t=75, codes=69-24-24, w=0.70) | 23.1818 | 38.5774 | 0.9457 | 24.3097 | 0.7500 | 3491568 | 3440032 | 24.00 | 24.00 | 72 | 0.3964 | 0.0000 | 9.32 | 50.64 |
| Truth-free rolling-safe action sequence (t=75, codes=73-24-24, w=0.70) | 25.1962 | 44.4508 | 0.8997 | 26.1932 | 0.8889 | 3470160 | 3418624 | 24.00 | 24.00 | 72 | 0.4248 | 0.0000 | 9.50 | 49.97 |
| Truth-free rolling-safe action sequence (t=75, codes=77-24-24, w=0.70) | 23.8239 | 38.6686 | 0.9410 | 22.9280 | 0.7639 | 3445368 | 3292104 | 23.67 | 24.00 | 72 | 0.4107 | 0.0000 | 9.37 | 49.63 |
| Truth-free rolling-safe action sequence (t=75, codes=24-24-24, w=0.70) | 22.3449 | 34.5380 | 0.9525 | 22.9908 | 0.6944 | 3472848 | 3373136 | 24.00 | 24.00 | 72 | 0.3964 | 0.0000 | 0.27 | 35.57 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=61-24-24, w=0.70) | 0.3964 | 1.0000 | 0.1042 | 3.00 | 0.6806 | 1.0000 | 1.21 | 0.0694 |
| Truth-free rolling-safe action sequence (t=75, codes=65-24-24, w=0.70) | 0.4522 | 1.0000 | 0.1250 | 3.00 | 0.6806 | 1.0000 | 1.25 | 0.0833 |
| Truth-free rolling-safe action sequence (t=75, codes=69-24-24, w=0.70) | 0.3964 | 1.0000 | 0.0833 | 3.00 | 0.6806 | 1.0000 | 1.17 | 0.0556 |
| Truth-free rolling-safe action sequence (t=75, codes=73-24-24, w=0.70) | 0.4248 | 1.0000 | 0.1042 | 3.00 | 0.6667 | 1.0000 | 1.21 | 0.0694 |
| Truth-free rolling-safe action sequence (t=75, codes=77-24-24, w=0.70) | 0.4107 | 1.0000 | 0.1250 | 3.00 | 0.6944 | 1.0000 | 1.25 | 0.0833 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=61-24-24, w=0.70) | 0.1042 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.5000 |
| Truth-free rolling-safe action sequence (t=75, codes=65-24-24, w=0.70) | 0.1250 | 3.00 | 0.6667 | 0.0000 | 1.0000 | 1.0000 | 0.6667 | 0.3333 | 1.0000 | 0.6667 |
| Truth-free rolling-safe action sequence (t=75, codes=69-24-24, w=0.70) | 0.0833 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.5000 |
| Truth-free rolling-safe action sequence (t=75, codes=73-24-24, w=0.70) | 0.1042 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.3333 | 0.3333 | 1.0000 | 0.6667 |
| Truth-free rolling-safe action sequence (t=75, codes=77-24-24, w=0.70) | 0.1250 | 3.00 | 0.0000 | 0.0000 | 1.0000 | 1.0000 | 0.0000 | 0.3333 | 1.0000 | 0.5833 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=61-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
| Truth-free rolling-safe action sequence (t=75, codes=65-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
| Truth-free rolling-safe action sequence (t=75, codes=69-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
| Truth-free rolling-safe action sequence (t=75, codes=73-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
| Truth-free rolling-safe action sequence (t=75, codes=77-24-24, w=0.70) | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.3333 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Truth-free rolling-safe action sequence (t=75, codes=61-24-24, w=0.70) | 23.8548 | 38.6686 | 3492384 | 0.1042 | 3.00 | 1.0000 | 0.6806 | 0.0694 | 0.0000 | 0.9252 | 24.0240 | 0.7778 |
| Truth-free rolling-safe action sequence (t=75, codes=65-24-24, w=0.70) | 23.3447 | 47.6170 | 3448584 | 0.1250 | 3.00 | 1.0000 | 0.6806 | 0.0833 | 0.0000 | 0.9219 | 26.1225 | 0.7917 |
| Truth-free rolling-safe action sequence (t=75, codes=69-24-24, w=0.70) | 23.1818 | 38.5774 | 3491568 | 0.0833 | 3.00 | 1.0000 | 0.6806 | 0.0556 | 0.0000 | 0.9457 | 24.3097 | 0.7500 |
| Truth-free rolling-safe action sequence (t=75, codes=73-24-24, w=0.70) | 25.1962 | 44.4508 | 3470160 | 0.1042 | 3.00 | 1.0000 | 0.6667 | 0.0694 | 0.0000 | 0.8997 | 26.1932 | 0.8889 |
| Truth-free rolling-safe action sequence (t=75, codes=77-24-24, w=0.70) | 23.8239 | 38.6686 | 3445368 | 0.1250 | 3.00 | 1.0000 | 0.6944 | 0.0833 | 0.0000 | 0.9410 | 22.9280 | 0.7639 |
...
|--:|:--|--:|--:|--:|
| 7 | Truth-free rolling-safe action sequence (t=75, codes=61-24-24, w=0.70) | 16 | 38.6686 | 23.8548 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=65-24-24, w=0.70) | 17 | 47.6170 | 23.3447 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=69-24-24, w=0.70) | 24 | 38.5774 | 23.1818 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=73-24-24, w=0.70) | 14 | 44.4508 | 25.1962 |
| 7 | Truth-free rolling-safe action sequence (t=75, codes=77-24-24, w=0.70) | 16 | 38.6686 | 23.8239 |
