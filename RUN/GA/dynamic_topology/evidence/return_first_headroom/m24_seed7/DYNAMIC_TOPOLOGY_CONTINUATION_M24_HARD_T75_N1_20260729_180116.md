...
- Preset: `m24-hard`
- Seeds: `7`
- Generated: 2026-07-29 18:01:16
- Evidence split: `development`
- Rejected learned artifact override: `0`
- Decision status: `rolling-safe-attribution-incomplete-controls`
- Primary attribution family: `rolling-safe`
- Available attribution families: `rolling-safe`
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Local only | 23.4600 | 42.0469 | 1.0402 | 25.1022 | 0.7500 | 0 | 0 | 29.00 | 58.00 | 0 | 0.0000 | 0.0000 | 0.00 | 15.77 |
| Directed fixed index control (w=0.50) | 20.0187 | 35.1414 | 0.8766 | 21.7539 | 0.6111 | 3505392 | 3452512 | 20.00 | 24.00 | 72 | 0.4786 | 0.0000 | 0.00 | 29.28 |
| Directed fixed cycle control (w=0.50) | 22.6913 | 38.5381 | 0.9259 | 23.5498 | 0.7222 | 3509952 | 3509952 | 24.00 | 24.00 | 72 | 0.3208 | 0.0000 | 0.00 | 32.31 |
| Rolling-safe posterior-analytic routing (w=0.50) | 24.1012 | 38.7993 | 0.8931 | 26.8553 | 0.8472 | 3409944 | 3361096 | 24.00 | 24.00 | 72 | 0.5289 | 0.0000 | 21.44 | 50.72 |
| Privileged rolling-safe current-risk teacher (w=0.50) | 21.6318 | 35.0717 | 0.9469 | 22.5520 | 0.6528 | 3481752 | 3431560 | 24.00 | 24.00 | 72 | 0.5042 | 0.0000 | 75.57 | 105.65 |
| Privileged rolling-safe minimax-risk teacher (w=0.50) | 21.4258 | 35.0938 | 0.9464 | 23.0780 | 0.6528 | 3474672 | 3371600 | 24.00 | 24.00 | 72 | 0.5042 | 0.0000 | 76.70 | 107.18 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|
| Local only | 0.0000 | 0.0000 | 0.0000 | 1.00 | 1.0000 | 1.0000 | 2.42 | 0.1379 |
| Directed fixed index control (w=0.50) | 0.4786 | 1.0000 | 0.0000 | 1.00 | 0.0000 | 1.0000 | 1.00 | 0.0000 |
| Directed fixed cycle control (w=0.50) | 0.3208 | 1.0000 | 0.0000 | 1.00 | 0.6667 | 1.0000 | 1.00 | 0.0000 |
| Rolling-safe posterior-analytic routing (w=0.50) | 0.5289 | 1.0000 | 0.2500 | 3.00 | 0.7083 | 1.0000 | 1.38 | 0.1250 |
| Privileged rolling-safe current-risk teacher (w=0.50) | 0.5042 | 1.0000 | 0.2083 | 3.00 | 0.7083 | 1.0000 | 1.38 | 0.1250 |
| Privileged rolling-safe minimax-risk teacher (w=0.50) | 0.5042 | 1.0000 | 0.2083 | 3.00 | 0.6944 | 1.0000 | 1.38 | 0.1250 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Local only | 0.0000 | 1.00 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.0000 | 1.0000 | 1.0000 | 1.0000 |
| Directed fixed index control (w=0.50) | 0.0000 | 1.00 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.3333 | 1.0000 | 0.0000 |
| Directed fixed cycle control (w=0.50) | 0.0000 | 1.00 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.3333 | 1.0000 | 0.0000 |
| Rolling-safe posterior-analytic routing (w=0.50) | 0.2500 | 3.00 | 0.6667 | 0.0000 | 1.0000 | 1.0000 | 0.6667 | 0.3333 | 1.0000 | 1.0000 |
| Privileged rolling-safe current-risk teacher (w=0.50) | 0.2083 | 3.00 | 0.0000 | 0.0000 | 1.0000 | 1.0000 | 0.0000 | 0.6667 | 1.0000 | 0.9167 |
| Privileged rolling-safe minimax-risk teacher (w=0.50) | 0.2083 | 3.00 | 0.3333 | 0.0000 | 1.0000 | 1.0000 | 0.0000 | 0.3333 | 1.0000 | 0.9167 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Local only | 1.0000 | 3 | 1.0000 | 3 | 0.6667 | 3 | 0.6667 | 3 | NaN | NaN | NaN | 0 | NaN | NaN | NaN | NaN | NaN |
| Directed fixed index control (w=0.50) | 0.6667 | 3 | 0.6667 | 3 | 0.6667 | 3 | 0.6667 | 3 | NaN | NaN | NaN | 0 | NaN | NaN | NaN | NaN | NaN |
| Directed fixed cycle control (w=0.50) | 0.6667 | 3 | 0.6667 | 3 | 0.6667 | 3 | 0.6667 | 3 | NaN | NaN | NaN | 0 | NaN | NaN | NaN | NaN | NaN |
| Rolling-safe posterior-analytic routing (w=0.50) | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
| Privileged rolling-safe current-risk teacher (w=0.50) | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
| Privileged rolling-safe minimax-risk teacher (w=0.50) | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 3 | 1.0000 | 1.0000 | 1.0000 | 3 | 1.0000 | 0.0000 | 1.0000 | 0.0000 | 0.0000 |
...
|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|
| Local only | 23.4600 | 42.0469 | 0 | 0.0000 | 1.00 | 1.0000 | 1.0000 | 0.1379 | 0.0000 | 1.0402 | 25.1022 | 0.7500 |
...
| Directed fixed cycle control (w=0.50) | 22.6913 | 38.5381 | 3509952 | 0.0000 | 1.00 | 1.0000 | 0.6667 | 0.0000 | 0.0000 | 0.9259 | 23.5498 | 0.7222 |
| Rolling-safe posterior-analytic routing (w=0.50) | 24.1012 | 38.7993 | 3409944 | 0.2500 | 3.00 | 1.0000 | 0.7083 | 0.1250 | 0.0000 | 0.8931 | 26.8553 | 0.8472 |
| Privileged rolling-safe current-risk teacher (w=0.50) | 21.6318 | 35.0717 | 3481752 | 0.2083 | 3.00 | 1.0000 | 0.7083 | 0.1250 | 0.0000 | 0.9469 | 22.5520 | 0.6528 |
| Privileged rolling-safe minimax-risk teacher (w=0.50) | 21.4258 | 35.0938 | 3474672 | 0.2083 | 3.00 | 1.0000 | 0.6944 | 0.1250 | 0.0000 | 0.9464 | 23.0780 | 0.6528 |

## Per-seed tail-node diagnostic

| Seed | Arm | Worst sensor | Sensor E-OSPA | Network mean E-OSPA |
|--:|:--|--:|--:|--:|
| 7 | Local only | 24 | 42.0469 | 23.4600 |
| 7 | Directed fixed index control (w=0.50) | 16 | 35.1414 | 20.0187 |
| 7 | Directed fixed cycle control (w=0.50) | 16 | 38.5381 | 22.6913 |
| 7 | Rolling-safe posterior-analytic routing (w=0.50) | 9 | 38.7993 | 24.1012 |
| 7 | Privileged rolling-safe current-risk teacher (w=0.50) | 16 | 35.0717 | 21.6318 |
| 7 | Privileged rolling-safe minimax-risk teacher (w=0.50) | 16 | 35.0938 | 21.4258 |
...
- Recommendation: Run every same-weight cyclic-chunk and burst phase plus the rolling-constrained link-aware control exactly once, verify its registered proposal/phase signature, and repair any duplicate or collapsed behavior before attribution.

## Privileged diagnostic-oracle readout

- Available: `1`
- Arm count: `2`
- Arms: `Privileged rolling-safe current-risk teacher (w=0.50), Privileged rolling-safe minimax-risk teacher (w=0.50)`
- Best diagnostic arm: `Privileged rolling-safe minimax-risk teacher (w=0.50)`
- Best diagnostic focus E-OSPA: 21.4258
- Best diagnostic attempted bytes: 3474672
...
- Candidate arm: `Rolling-safe posterior-analytic routing (w=0.50)`
- Candidate mode: `rolling-safe-analytic-w50`
- Available candidates: `1`
- Observed candidate instances: `1`
- Duplicate canonical candidates: ``
- Selected candidate mode duplicated: `0`
- Candidate source weight: 0.50
- Scenario contract valid: `1`
- Formations: `4`
- Expected registered controls: `31`
- Observed control instances: `0`
- Uniquely observed controls: `0`
- Contract-valid controls: `0`
- Missing controls: `directed-rolling-chunk-q2-dcw-c0-w50 | directed-rolling-chunk-q2-dcw-c1-w50 | directed-rolling-chunk-q2-dccw-c0-w50 | directed-rolling-chunk-q2-dccw-c1-w50 | directed-rolling-chunk-q3-dcw-c0-w50 | directed-rolling-chunk-q3-dccw-c0-w50 | directed-rolling-burst-r1-dcw-p0-w50 | directed-rolling-burst-r1-dcw-p1-w50 | directed-rolling-burst-r1-dcw-p2-w50 | directed-rolling-burst-r1-dccw-p0-w50 | directed-rolling-burst-r1-dccw-p1-w50 | directed-rolling-burst-r1-dccw-p2-w50 | directed-rolling-burst-r2-dcw-p0-w50 | directed-rolling-burst-r2-dcw-p1-w50 | directed-rolling-burst-r2-dcw-p2-w50 | directed-rolling-burst-r2-dccw-p0-w50 | directed-rolling-burst-r2-dccw-p1-w50 | directed-rolling-burst-r2-dccw-p2-w50 | directed-rolling-burst-r3-dcw-p0-w50 | directed-rolling-burst-r3-dcw-p1-w50 | directed-rolling-burst-r3-dcw-p2-w50 | directed-rolling-burst-r3-dccw-p0-w50 | directed-rolling-burst-r3-dccw-p1-w50 | directed-rolling-burst-r3-dccw-p2-w50 | directed-rolling-burst-r4-dcw-p0-w50 | directed-rolling-burst-r4-dcw-p1-w50 | directed-rolling-burst-r4-dcw-p2-w50 | directed-rolling-burst-r4-dccw-p0-w50 | directed-rolling-burst-r4-dccw-p1-w50 | directed-rolling-burst-r4-dccw-p2-w50 | directed-link-aware-rolling-b3-w50`
- Duplicate controls: ``
- Invalid controls: ``
- Complete matched control set: `0`
- Scheduled behavior contract passed: `0`
- Collapsed scheduled behaviors: ``
- Candidate contract passed: `1`
- Selected-route safety passed: `0`
- Observable policy contract passed: `0`
- Joint current/successor projection used: `1`
- Online payload constraint enforced: `0`
- Maturity denominators matched: `0`
- Maturity denominators complete: `1`
- Maturity fields: ``
...
- Rolling-safe status: `rolling-safe-attribution-incomplete-controls`
