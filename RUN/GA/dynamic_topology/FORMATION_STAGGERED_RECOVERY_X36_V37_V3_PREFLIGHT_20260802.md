# V37 X36 frozen source-only preflight v3

- Contract / generation commit: `formation-staggered-recovery-x36-v37-preflight-v3 / faa6d4e99137fedf9c65c951b0e02d02d6dc3d46`
...
- Registered executable-source manifest SHA-256: `1127516ddcb5ce0e07a5cf0bd9942153cc2cf08c9f1b76d915aa4318273db2a3`
- Publication completion marker: `RUN/GA/dynamic_topology/evidence/formation_value_v37/x36_source_v3/preflight/FORMATION_STAGGERED_RECOVERY_X36_V37_V3_PREFLIGHT.mat.complete` (`formation-staggered-recovery-source-publication-v1`)
...
- Initial control / reference replay / candidate replay: `127.75 / 142.74 / 516.04 s`
...
- Initial control / reference replay / candidate replay: `126.91 / 137.80 / 488.68 s`
...
- Initial control / reference replay / candidate replay: `124.41 / 119.85 / 467.97 s`
...
All three X36 states reproduce the frozen source metrics, initial actions, all six complete H=3 runtime fingerprints, current-observable input contracts, and semantic cache provenance from clean source. The three structured pair proposals are eligible for a separate hashed outcome permit. This preflight itself authorizes no tracking run.
