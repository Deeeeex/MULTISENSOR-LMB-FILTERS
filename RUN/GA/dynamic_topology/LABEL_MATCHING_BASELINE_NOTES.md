...
2026-09-06。设计笔记；尚未实现新匹配算法。V288 先单独检验共享标签
下的 MIL 融合规则，避免把改变融合准则误认为标签匹配的效果。
