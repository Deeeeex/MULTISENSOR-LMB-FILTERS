...
if getField(experimentOverrides, 'includePayloadRefinementVariants', false)
    ...
    cfg.mixtureAwareTopComponents = getField(experimentOverrides, ...
        'mixtureAwareTopComponents', 2);
    cfg.mixtureAwareMaxFusedComponents = getField(experimentOverrides, ...
        'mixtureAwareMaxFusedComponents', 6);
    cfg.mixtureAwareMinEntropy = getField(experimentOverrides, ...
        'mixtureAwareMinEntropy', 0.35);
    cfg.mixtureAwareMinExistence = getField(experimentOverrides, ...
        'mixtureAwareMinExistence', 0.7);
    arms(end+1) = makeArm( ...
        'Light-floor mixed-label payload + mixture-aware heavy fusion + dynamic topology', ...
        'High-entropy heavy labels enter label-wise GM-KLA fusion instead of being moment matched.', ...
        cfg);
