...
% GENERATEFORMATIONH3REFERENCESTATECACHES Registered-reference trajectory.
%
% Runs one truth-free reference filter trajectory and writes one
...
v63Protocol = getTrackingAlignedX36ScheduleHeadroomV63Protocol();
v66Protocol = ...
    getInfluenceAwareDecisionBreadthV66SceneDiscoveryProtocol();
v69Protocol = getSignedMergeSplitOpportunityV69Protocol();
v84Protocol = getBraidedHandoverOpportunityV84Protocol();
if strcmp(protocol.id, v58Protocol.id)
...
config.topologyPolicyName = getField(protocol, ...
    'referencePolicyName', 'formation-h3-fixed-ccw-reference-v1');
...
v69Protocol = getSignedMergeSplitOpportunityV69Protocol();
v84Protocol = getBraidedHandoverOpportunityV84Protocol();
if strcmp(protocol.id, v69Protocol.id) || ...
        strcmp(protocol.id, v84Protocol.id)
...
allowedIds = { ...
    ...
    'tracking-aligned-formation-h3-v56-headroom-v1', ...
    ...
    'signed-merge-split-opportunity-v69-v1', ...
    'braided-handover-opportunity-v84-v1'};
