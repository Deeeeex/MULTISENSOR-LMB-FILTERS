...
result.nextMethodDecision = conditionalValue( ...
    ...
    'close-risk-rooted-tree-and-test-label-selective-edge-trust');
...
if result.actionMechanismPassed
    ...
    fprintf(fid, ['The componentwise shortest risk-rooted tree does ', ...
        ...
        'Close formation-tree-only routing and test label-selective ', ...
        'edge trust before any learned ranker.\n\n']);
end
