...
for armIdx = 1:numel(armNames)
    ...
    context = buildExecutionContext( ...
        presetName, seed, splitName, armName, armId, ...
        config.topologyPolicyName, inputs.config.simulationLength);
...
function context = buildExecutionContext( ...
        presetName, seed, splitName, armName, armId, ...
        policyName, timeCount)
context = buildDirectGraphPayloadRepairV214ExecutionContext( ...
    presetName, seed, [splitName, '-v227-', armName], ...
    1, timeCount, armId, false, struct());
context.contractVersion = ...
    'corrected-static-routing-v227-execution-context-v1';
context.capability = ...
    'corrected-static-routing-v227-development';
context.action = ...
    'filter-corrected-static-routing-v227-development';
context.policyName = policyName;
context.onlineReselectionEnabled = strcmp(armName, 'dynamic');
end
