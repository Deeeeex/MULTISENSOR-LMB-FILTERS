...
for objectIdx = 1:numel(predictedObjects)
    ...
    targetDetectionProbabilities(objectIdx) = ...
        min(max(objectDetectionProbability, 0), 1);
end
...
details = struct( ...
    ...
    'measurementIntensity', measurementIntensity, ...
