...
localQualityGateEnabled = getField(config, 'localQualityGateEnabled', true);
...
for labelIdx = 1:numLabels
    ...
    if localQualityGateEnabled
        qualityMultiplier = localQuality(labelIdx);
    else
        qualityMultiplier = 1;
    end
    perLabel(labelIdx) = qualityMultiplier * ...
