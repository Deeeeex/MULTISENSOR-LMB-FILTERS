...
details = struct( ...
    ...
    'policyRepairTriggered', false, ...
    'policyFormationWindowStrong', true, ...
    'policySensorWindowStrong', true, ...
    'policySuccessorSensorStrong', true, ...
    'policyPayloadLimitPassed', true, ...
    'policyPayloadEmergencyUsed', false, ...
...
if ~isempty(triggerConfig.topologyPolicyFcn)
    ...
    details.policyRepairTriggered = logical(getField( ...
        policyDetails, 'repairTriggered', false));
    details.policyFormationWindowStrong = logical(getField( ...
        policyDetails, 'formationWindowStrongConnected', true));
    details.policySensorWindowStrong = logical(getField( ...
        policyDetails, 'sensorWindowStrongConnected', true));
    details.policySuccessorSensorStrong = logical(getField( ...
        policyDetails, 'successorSensorStrongConnected', true));
    details.policyPayloadLimitPassed = logical(getField( ...
        policyDetails, 'payloadLimitPassed', true));
    details.policyPayloadEmergencyUsed = logical(getField( ...
        policyDetails, 'payloadEmergencyUsed', false));
