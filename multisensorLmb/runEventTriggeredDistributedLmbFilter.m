            ...
            if eventType > 0
                ...
                if delivered
                    ...
                    diagnostics.payloadBytes( ...
                        senderIdx, receiverIdx, currentTime) = ...
                        payloadStats.estimatedBytes;
                    diagnostics.deliveredPayloadScalars( ...
                        senderIdx, receiverIdx, currentTime) = ...
                        payloadStats.scalarCount;
...
diagnostics.deliveredPayloadScalars = zeros(shape);
