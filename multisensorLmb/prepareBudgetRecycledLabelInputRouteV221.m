...
if ~iscell(localPosteriorBySensor) || sensorCount < 1 || ...
        ...
        ~validNonnegativeExtendedScalar( ...
...
if applied
    ...
    route.maximumReferenceLogOddsIncrease = ...
        maximumReferenceLogOddsIncrease;
    route.transferFractionGrid = transferFractionGrid;
...
details.maximumReferenceLogOddsIncrease = ...
    maximumReferenceLogOddsIncrease;
details.transferFractionGrid = transferFractionGrid;
...
details.dominantNonselfTransferEnabled = ...
    ismember(weightMode, { ...
        'dominant-nonself-transfer', ...
        'bounded-dominant-nonself-transfer'});
details.boundedDominantNonselfTransferEnabled = ...
...
function valid = validNonnegativeExtendedScalar(value)
valid = isscalar(value) && isnumeric(value) && ...
    ~isnan(value) && value >= 0;
end
