...
% cannot perturb unrelated labels.  For its selected label only, the source
% receives a fixed share and all ordinary inputs retain their relative
% proportions.  This avoids the order dependence of a second post-fusion
% KLA update.
...
for overrideIdx = 1:numel(overrides)
    ...
    required = {'label', 'sourceInputIndex', 'sourceWeight', 'mode'};
