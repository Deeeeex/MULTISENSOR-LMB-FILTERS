...
% either allocate a fixed proportional share or transfer one ordinary input
% edge's complete weight to the source.  Both modes stay inside the single
% ordinary KLA call and avoid a second post-fusion update.
